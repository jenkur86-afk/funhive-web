...
| `FunHive-Macaroni` | daily 3:00 PM | `scrapers/run-macaroni.bat` | 30h | same logs as `FunHive-Scrapers`, plus `scrapers/logs/macaroni-daily-<date>.log`, `macaroni-last-run.json` |
