...
<!-- STATUS-DATA {"date":"2026-08-10","countiesResolve":98.4,"urlCollisions":767,"confirmedBugs":67,"unknownSites":383,"specificAgeShare":40.6,"nameConformance":46.4,"sourceUrlCoverage":62,"countyCoverage":0} -->
...
| 2. URLs unique per state | 767 | -20 ✅ | 0 | blocks gates 3 and 5 — selector work on a wrong URL imports the wrong library |
| 3. Zero confirmed bugs | 67 | -53 ✅ | 0 | mostly blocked on gate 2 |
| 4. Zero unknown sites | 383 | · | 0 | independent — re-checking is its own pass |
...
| 🟠 | Confirmed open bugs (MISMATCH verdicts) | 67 sites | most blocked on the URL work above |
| 🟠 | Unknown sites (UNVERIFIABLE verdicts) | 383 sites | bot-blocks / JS-only calendars / TLS failures — never re-checked |
| 🟠 | Age detection — most events still land in the All Ages catch-all | 40.6% resolved (best ever 40.6% on 2026-08-09) | MASTER-PLAN Phase 5, not started |
