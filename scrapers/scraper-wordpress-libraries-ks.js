...
const LIBRARIES = [
  ...
  { name: 'Lawrence Public Library', url: 'https://lawrenceks.gov/', eventsUrl: 'https://lawrenceks.gov/2024/10/library-partnership-brings-books-to-central-station-lobby/', city: 'Lawrence', state: 'KS', zipCode: '66044', county: 'Lawrence County'},
  ...
  { name: 'Leavenworth Public Library', url: 'https://leavenworthpubliclibrary.org/', eventsUrl: 'https://leavenworthpubliclibrary.org/', city: 'Leavenworth', state: 'KS', zipCode: '66048', county: 'Leavenworth County'},
  ...
  { name: 'Emporia Public Library', url: 'https://www.emporialibrary.org/', eventsUrl: 'https://www.emporialibrary.org/', city: 'Emporia', state: 'KS', zipCode: '66801', county: 'Emporia County'},
  ...
  { name: 'Pittsburg Public Library', url: 'https://www.pittsburglibrary.org/', eventsUrl: 'https://www.pittsburglibrary.org/', city: 'Pittsburg', state: 'KS', zipCode: '66762', county: 'Pittsburg County'},
  ...
  { name: 'Hays Public Library', url: 'https://hayslibrary.org/', eventsUrl: 'https://hayslibrary.org/', city: 'Hays', state: 'KS', zipCode: '67601', county: 'Hays County'},
  ...
  { name: 'El Dorado Public Library', url: 'https://eldoradolibrary.org/', eventsUrl: 'https://eldoradolibrary.org/', city: 'El Dorado', state: 'KS', zipCode: '67042', county: 'El Dorado County'},
  { name: 'Ottawa Library', url: 'https://www.ottawalibrary.org/', eventsUrl: 'https://www.ottawalibrary.org/', city: 'Ottawa', state: 'KS', zipCode: '66067', county: 'Ottawa County'},
  { name: 'Winfield Public Library', url: 'https://wpl.org/', eventsUrl: 'https://wpl.org/', city: 'Winfield', state: 'KS', zipCode: '67156', county: 'Winfield County'},
...
module.exports = { scrapeGenericEvents, saveToDatabase, scrapeWordpressKSCloudFunction };
