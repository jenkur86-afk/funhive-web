...
const LIBRARIES = [
  ...
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Bridgeport Public Library', url: 'https://www.bportlibrary.org', eventsUrl: 'https://www.bportlibrary.org/events', city: 'Bridgeport', state: 'CT', zipCode: '06604', county: 'Greater Bridgeport Planning Region', urlCollision: 'platform mismatch - already covered by LibCal-CT at bportlibrary.libcal.com; this entry was a live duplicate' },
  // Regional Libraries
  ...
  { name: 'Waterbury Public Library', url: 'https://bronsonlibrary.org', eventsUrl: 'https://bronsonlibrary.org/events', city: 'Waterbury', state: 'CT', zipCode: '06702', county: 'Naugatuck Valley Planning Region', urlCollision: "dead/hijacked domain, confirmed: dead-domain: the configured URL redirects to forsale.godaddy.com, a GoDaddy parked \"domain for sale\" page — the library no longer controls this domain, so extraction can never succeed here and the entry needs a correct URL or a guard Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Norwalk Public Library', url: 'https://norwalkpl.org', eventsUrl: 'https://norwalkpl.org/calendar.aspx', city: 'Norwalk', state: 'CT', zipCode: '06850', county: 'Western Connecticut Planning Region', urlCollision: "dead/hijacked domain, confirmed: dead-domain: the configured URL redirects to agentaruhanjuditogel.com, an online gambling site — the library no longer controls this domain, so extraction can never succeed here and the entry needs a correct URL or a guard Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Fairfield Public Library', url: 'https://www.fairfieldpubliclibrary.org', eventsUrl: 'https://www.fairfieldpubliclibrary.org/events', city: 'Fairfield', state: 'CT', zipCode: '06824', county: 'Fairfield County', urlCollision: 'publishes on fplct.librarymarket.com - link taken from the library own page, CT confirmed by ZIPs 06824 and 06825 with area code 203. Relocated to LibraryMarket-CT on 2026-08-27'},
  ...
  { name: 'Milford Public Library', url: 'https://www.ci.milford.ct.us/milford-public-library', eventsUrl: 'https://www.ci.milford.ct.us/milford-public-library/events', city: 'Milford', state: 'CT', zipCode: '06460', county: 'South Central Connecticut Planning Region', urlCollision: "dead/hijacked domain, confirmed: dead-endpoint: HTTP 404 on the configured URL [redirects to milfordct.us] Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Andover Public Library', url: 'https://www.andoverlibrary.org', eventsUrl: 'https://www.andoverlibrary.org/events', city: 'Andover', state: 'CT', zipCode: '06232', county: 'Capitol Planning Region', urlCollision: 'andoverlibrary.org is KS, not CT' },
  ...
  { name: 'Bethlehem Public Library', url: 'https://www.bethlehemlibrary.org', eventsUrl: 'https://www.bethlehemlibrary.org/events', city: 'Bethlehem', state: 'CT', zipCode: '06751', county: 'Naugatuck Valley Planning Region', urlCollision: 'bethlehemlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Henry Carter Hull Library', url: 'https://www.clintonlibrary.org', eventsUrl: 'https://www.clintonlibrary.org/events', city: 'Clinton', state: 'CT', zipCode: '06413', county: 'Lower Connecticut River Valley Planning Region', urlCollision: 'clintonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Saxton B. Little Free Library', url: 'https://www.columbialibrary.org', eventsUrl: 'https://www.columbialibrary.org/events', city: 'Columbia', state: 'CT', zipCode: '06237', county: 'Capitol Planning Region', urlCollision: 'columbialibrary.org is IL, not CT' },
  ...
  { name: 'Essex Library Association', url: 'https://www.essexlibrary.org', eventsUrl: 'https://www.essexlibrary.org/events', city: 'Essex', state: 'CT', zipCode: '06426', county: 'Lower Connecticut River Valley Planning Region', urlCollision: 'essexlibrary.org is NY, not CT' },
  { name: 'Farmington Library', url: 'https://www.farmingtonpublic.org/', eventsUrl: 'https://www.farmingtonpublic.org/', city: 'Farmington', state: 'CT', zipCode: '06032', county: 'Capitol Planning Region', urlCollision: 'farmingtonpublic.org is IL, not CT' },
  { name: 'Janet Carlson Calvert Library', url: 'https://www.franklinlibrary.org', eventsUrl: 'https://www.franklinlibrary.org/events', city: 'Franklin', state: 'CT', zipCode: '00000', county: 'Southeastern Connecticut Planning Region', urlCollision: 'franklinlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Goshen Public Library', url: 'https://www.goshenlibrary.org/', eventsUrl: 'https://www.goshenlibrary.org/', city: 'Goshen', state: 'CT', zipCode: '06756', county: 'Northwest Hills Planning Region', urlCollision: 'goshenlibrary.org is NH, not CT' },
  { name: 'Frederick H. Cossitt Library', url: 'https://granbylibrary.org/', eventsUrl: 'https://granbylibrary.org/', city: 'Granby', state: 'CT', zipCode: '00000', county: 'Capitol Planning Region', urlCollision: 'granbylibrary.org is MA, not CT' },
  ...
  { name: 'Hartland Public Library', url: 'https://www.hartlandlibrary.org', eventsUrl: 'https://www.hartlandlibrary.org/events', city: 'Hartland', state: 'CT', zipCode: '06091', county: 'Northwest Hills Planning Region', urlCollision: 'hartlandlibrary.org is WI, not CT' },
  ...
  { name: 'Douglas Library Of Hebron', url: 'https://www.hebronlibrary.org', eventsUrl: 'https://www.hebronlibrary.org/events', city: 'Hebron', state: 'CT', zipCode: '06248', county: 'Capitol Planning Region', urlCollision: 'hebronlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  // 2026-08-27: PLATFORM MISMATCH. Killingworth publishes on killingworthlibrary.libcal.com, titled "LibCal - Killingworth Library Association".
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Killingworth Library', url: 'https://www.killingworthlibrary.org', eventsUrl: 'https://www.killingworthlibrary.org/events', city: 'Killingworth', state: 'CT', zipCode: '06419', county: 'Lower Connecticut River Valley Planning Region', urlCollision: 'platform mismatch - publishes on killingworthlibrary.libcal.com; relocated to LibCal-CT 2026-08-27' },
  { name: 'Jonathan Trumbull Library', url: 'https://lebanonlibrary.org/', eventsUrl: 'https://lebanonlibrary.org/', city: 'Lebanon', state: 'CT', zipCode: '06249', county: 'Southeastern Connecticut Planning Region', urlCollision: 'lebanonlibrary.org is OH, not CT' },
  ...
  { name: 'Edith Wheeler Memorial Library', url: 'https://www.monroelibrary.org', eventsUrl: 'https://www.monroelibrary.org/events', city: 'Monroe', state: 'CT', zipCode: '06468', county: 'Greater Bridgeport Planning Region', urlCollision: 'monroelibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Plainville Public Library', url: 'https://www.plainvillelibrary.org', eventsUrl: 'https://www.plainvillelibrary.org/events', city: 'Plainville', state: 'CT', zipCode: '06062', county: 'Capitol Planning Region', urlCollision: 'plainvillelibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Pomfret Public Library', url: 'https://www.pomfretlibrary.org', eventsUrl: 'https://www.pomfretlibrary.org/events', city: 'Pomfret', state: 'CT', zipCode: '06258', county: 'Northeastern Connecticut Planning Region', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  { name: 'Preston Public Library', url: 'https://prestonpubliclibrary.org/', eventsUrl: 'https://prestonpubliclibrary.org/events/', city: 'Preston', state: 'CT', zipCode: '06365', county: 'New London County'},
  // REMOVED 2026-08-11 (MASTER-PLAN Defect A): configured host serves a library in PA, not CT. Confirmed live in reports/verification-comments.json. Removed now rather than later because today's date-extraction fixes mean this scraper CAN now read pages it previously failed on, which would have started importing another state's events under this name. RECORDED COVERAGE GAP - restore when a real URL is verified.
  ...
  // URL corrected 2026-08-11 (was roxburylibrary.org): 23 South Street Roxbury CT 06783, phone 860-350-2181
  { name: 'Minor Memorial Library', url: 'https://www.minormemoriallibrary.org', eventsUrl: 'https://www.minormemoriallibrary.org', city: 'Roxbury', state: 'CT', zipCode: '06783', county: 'Western Connecticut Planning Region'},
  { name: 'Salem Free Public Library', url: 'https://www.salemlibrary.org', eventsUrl: 'https://www.salemlibrary.org/events', city: 'Salem', state: 'CT', zipCode: '06420', county: 'Southeastern Connecticut Planning Region', urlCollision: 'salemlibrary.org is OR, not CT' },
  { name: 'Scoville Memorial Library', url: 'https://www.salisburylibrary.org/', eventsUrl: 'https://www.salisburylibrary.org/', city: 'Salisbury', state: 'CT', zipCode: '06068', county: 'Northwest Hills Planning Region', urlCollision: 'salisburylibrary.org is MA, not CT' },
  ...
  { name: 'Pequot Library Association', url: 'https://www.southportlibrary.org', eventsUrl: 'https://www.southportlibrary.org/events', city: 'Southport', state: 'CT', zipCode: '06890', county: 'Greater Bridgeport Planning Region', urlCollision: 'southportlibrary.org is ME, not CT' },
  ...
  { name: 'Stonington Free Library', url: 'https://www.stoningtonlibrary.org/', eventsUrl: 'https://www.stoningtonlibrary.org/', city: 'Stonington', state: 'CT', zipCode: '06378', county: 'Southeastern Connecticut Planning Region', urlCollision: 'stoningtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Kent Memorial Library', url: 'https://www.suffieldlibrary.org', eventsUrl: 'https://www.suffieldlibrary.org/events', city: 'Suffield', state: 'CT', zipCode: '06078', county: 'Capitol Planning Region', urlCollision: "dead/hijacked domain, confirmed: suffieldlibrary.org is a parked domain - page says This domain may be for sale, no library content Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Warren Public Library', url: 'https://www.warrenlibrary.org', eventsUrl: 'https://www.warrenlibrary.org/events', city: 'Warren', state: 'CT', zipCode: '06754', county: 'Northwest Hills Planning Region', urlCollision: 'warrenlibrary.org is PA, not CT' },
  { name: 'Waterford Public Library', url: 'https://www.waterfordlibrary.org', eventsUrl: 'https://www.waterfordlibrary.org/events', city: 'Waterford', state: 'CT', zipCode: '06385', county: 'Southeastern Connecticut Planning Region', urlCollision: 'waterfordlibrary.org is WA, not CT' },
  ...
  { name: 'Wilson Branch Library', url: 'https://www.windsorlibrary.org', eventsUrl: 'https://www.windsorlibrary.org/events', city: 'Windsor', state: 'CT', zipCode: '00000', county: 'Capitol Planning Region', urlCollision: 'windsorlibrary.org is VT, not CT' },
