...
const LIBRARIES = [
  ...
  { name: 'Danbury Public Library', url: 'https://danburylibrary.org/', eventsUrl: 'https://danburylibrary.org/', city: 'Danbury', state: 'CT', zipCode: '06810', county: 'Danbury County'},
  ...
  { name: 'West Hartford Public Library', url: 'https://www.westhartfordlibrary.org/', eventsUrl: 'https://www.westhartfordlibrary.org/', city: 'West Hartford', state: 'CT', zipCode: '06107', county: 'West Hartford County'},
  { name: 'Greenwich Library', url: 'https://www.greenwichlibrary.org/', eventsUrl: 'https://www.greenwichlibrary.org/', city: 'Greenwich', state: 'CT', zipCode: '06830', county: 'Greenwich County'},
  ...
  { name: 'Manchester Public Library', url: 'https://www.manchesterct.gov/', eventsUrl: 'https://www.manchesterct.gov/Government/Departments/Library', city: 'Manchester', state: 'CT', zipCode: '06040', county: 'Manchester County'},
  ...
  { name: 'Middletown Public Library', url: 'https://russelllibrary.org/', eventsUrl: 'https://russelllibrary.org/', city: 'Middletown', state: 'CT', zipCode: '06457', county: 'Middletown County'},
  ...
  { name: 'Enfield Public Library', url: 'https://www.enfieldpubliclibrary.org/', eventsUrl: 'https://www.enfieldpubliclibrary.org/', city: 'Enfield', state: 'CT', zipCode: '06082', county: 'Enfield County'},
  { name: 'Southington Public Library', url: 'https://www.southingtonlibrary.org/', eventsUrl: 'https://www.southingtonlibrary.org/', city: 'Southington', state: 'CT', zipCode: '06489', county: 'Southington County'},
  ...
  { name: 'Trumbull Library', url: 'https://www.trumbull-ct.gov/', eventsUrl: 'https://www.trumbull-ct.gov/1104/Library', city: 'Trumbull', state: 'CT', zipCode: '06611', county: 'Trumbull County'},
  ...
  { name: 'Ansonia Public Library', url: 'https://ansonialibrary.org/', eventsUrl: 'https://ansonialibrary.org/', city: 'Ansonia', state: 'CT', zipCode: '06401', county: 'Ansonia County'},
  ...
  { name: 'Clark Memorial Library', url: 'https://bethanylibrary.org/', eventsUrl: 'https://bethanylibrary.org/', city: 'Bethany', state: 'CT', zipCode: '06524', county: 'Bethany County'},
  ...
  { name: 'Chester Public Library', url: 'https://www.chesterlibrary.org/', eventsUrl: 'https://www.chesterlibrary.org/', city: 'Chester', state: 'CT', zipCode: '06412', county: 'Chester County'},
  ...
  { name: 'Booth Dimock Memorial Library', url: 'https://www.coventrylibrary.org/', eventsUrl: 'https://www.coventrylibrary.org/', city: 'Coventry', state: 'CT', zipCode: '06238', county: 'Coventry County'},
  ...
  { name: 'Easton Public Library', url: 'https://www.eastonlibrary.org/', eventsUrl: 'https://www.eastonlibrary.org/library-events', city: 'Easton', state: 'CT', zipCode: '06612', county: 'Easton County'},
  ...
  { name: 'Farmington Library', url: 'https://www.farmingtonpublic.org/', eventsUrl: 'https://www.farmingtonpublic.org/', city: 'Farmington', state: 'CT', zipCode: '06032', county: 'Farmington County'},
  ...
  { name: 'Goshen Public Library', url: 'https://www.goshenlibrary.org/', eventsUrl: 'https://www.goshenlibrary.org/', city: 'Goshen', state: 'CT', zipCode: '06756', county: 'Goshen County'},
  { name: 'Frederick H. Cossitt Library', url: 'https://granbylibrary.org/', eventsUrl: 'https://granbylibrary.org/', city: 'Granby', state: 'CT', zipCode: '00000', county: 'Granby County'},
  { name: 'Community Branch Library', url: 'https://hamdenlibrary.org/', eventsUrl: 'https://hamdenlibrary.org/', city: 'Hamden', state: 'CT', zipCode: '00000', county: 'Hamden County'},
  ...
  { name: 'Kent Library Association', url: 'https://kentpl.librarycalendar.com/', eventsUrl: 'https://kentpl.librarycalendar.com/events/month', city: 'Kent', state: 'CT', zipCode: '06757', county: 'Kent County'},
  ...
  { name: 'Jonathan Trumbull Library', url: 'https://lebanonlibrary.org/', eventsUrl: 'https://lebanonlibrary.org/', city: 'Lebanon', state: 'CT', zipCode: '06249', county: 'Lebanon County'},
  ...
  { name: 'Levi E.Coe Library', url: 'https://middlefieldlibrary.org/', eventsUrl: 'https://middlefieldlibrary.org/', city: 'Middlefield', state: 'CT', zipCode: '06455', county: 'Middlefield County'},
  ...
  { name: 'New Fairfield Free Public Library', url: 'https://www.newfairfieldlibrary.org/', eventsUrl: 'https://www.newfairfieldlibrary.org/', city: 'New Fairfield', state: 'CT', zipCode: '06812', county: 'New Fairfield County'},
  ...
  { name: 'New Milford Public Library', url: 'https://newmilfordlibrary.org/', eventsUrl: 'https://newmilfordlibrary.org/', city: 'New Milford', state: 'CT', zipCode: '06776', county: 'New Milford County'},
  { name: 'Cyrenius H. Booth Library', url: 'https://newtownlibrary.org/', eventsUrl: 'https://newtownlibrary.org/', city: 'Newtown', state: 'CT', zipCode: '06470', county: 'Newtown County'},
  ...
  { name: 'Otis Library', url: 'https://www.norwichlibrary.org/', eventsUrl: 'https://www.norwichlibrary.org/category/events/', city: 'Norwich', state: 'CT', zipCode: '06360', county: 'Norwich County'},
  ...
  { name: 'Oxford Public Library', url: 'https://oxfordlibrary.org/', eventsUrl: 'https://oxfordlibrary.org/', city: 'Oxford', state: 'CT', zipCode: '06478', county: 'Oxford County'},
  ...
  { name: 'Plymouth Library Association', url: 'https://plymouthlibrary.org/', eventsUrl: 'https://plymouthlibrary.org/', city: 'Plymouth', state: 'CT', zipCode: '06782', county: 'Plymouth County'},
  ...
  { name: 'Prospect Public Library', url: 'https://www.prospectlibrary.org/', eventsUrl: 'https://www.prospectlibrary.org/calendar', city: 'Prospect', state: 'CT', zipCode: '06712', county: 'Prospect County'},
  { name: 'Ridgefield Library', url: 'https://ridgefieldlibrary.org/', eventsUrl: 'https://ridgefieldlibrary.org/', city: 'Ridgefield', state: 'CT', zipCode: '06877', county: 'Ridgefield County'},
  ...
  { name: 'Scoville Memorial Library', url: 'https://www.salisburylibrary.org/', eventsUrl: 'https://www.salisburylibrary.org/', city: 'Salisbury', state: 'CT', zipCode: '06068', county: 'Salisbury County'},
  ...
  { name: 'Sherman Library Assn.', url: 'https://www.shermanlibrary.org/', eventsUrl: 'https://www.shermanlibrary.org/', city: 'Sherman', state: 'CT', zipCode: '06784', county: 'Sherman County'},
  ...
  { name: 'Stonington Free Library', url: 'https://www.stoningtonlibrary.org/', eventsUrl: 'https://www.stoningtonlibrary.org/', city: 'Stonington', state: 'CT', zipCode: '06378', county: 'Stonington County'},
  ...
  { name: 'Thomaston Public Library', url: 'https://thomastonlibrary.org/', eventsUrl: 'https://thomastonlibrary.org/', city: 'Thomaston', state: 'CT', zipCode: '06787', county: 'Thomaston County'},
  ...
  { name: 'Oakville Branch Library', url: 'https://www.watertownlibrary.org/', eventsUrl: 'https://www.watertownlibrary.org/', city: 'Watertown', state: 'CT', zipCode: '00000', county: 'Watertown County'},
  ...
  { name: 'Wethersfield Public Library', url: 'https://www.wethersfieldlibrary.org/', eventsUrl: 'https://www.wethersfieldlibrary.org/', city: 'Wethersfield', state: 'CT', zipCode: '06109', county: 'Wethersfield County'},
  ...
  { name: 'Woodbridge Town Library', url: 'https://www.woodbridgelibrary.org/', eventsUrl: 'https://www.woodbridgelibrary.org/calendar.aspx', city: 'Woodbridge', state: 'CT', zipCode: '06525', county: 'Woodbridge County'},
