...
const LIBRARIES = [
  ...
  { name: 'Clermont Library', url: 'https://www.clermontlibrary.org/', eventsUrl: 'https://www.clermontlibrary.org/', city: 'Clermont', state: 'GA', zipCode: '00000', county: 'Hall', urlCollision: 'clermontlibrary.org is OH, not GA' },
  { name: 'White County Public Library-Cleveland Branch', url: 'https://clevelandlibrary.org/', eventsUrl: 'https://clevelandlibrary.org/', city: 'Cleveland', state: 'GA', zipCode: '00000', county: 'White', urlCollision: 'clevelandlibrary.org is TN, not GA' },
  { name: 'Chattahoochee Valley Regional Library System', url: 'https://www.columbuslibrary.org', eventsUrl: 'https://www.columbuslibrary.org/events', city: 'Columbus', state: 'GA', zipCode: '31906', county: 'Muscogee', urlCollision: 'columbuslibrary.org is OH, not GA' },
  ...
  { name: 'Monroe County Library', url: 'https://www.forsythlibrary.org', eventsUrl: 'https://www.forsythlibrary.org/events', city: 'Forsyth', state: 'GA', zipCode: '00000', county: 'Forsyth County', urlCollision: "urlCollision confirmed 2026-09-07: forsythlibrary.org is alive but titles itself \"Forsyth County Library, Forsyth County, NORTH CAROLINA\". Monroe County Library is in Forsyth, GEORGIA. Two Forsyths, and this host serves the wrong one - the same {city}library.org guess as the rest of Defect A. Found while probing for a working path, which is why the probe result PATH-FOUND was not taken at face value. OPEN COVERAGE GAP" },
  ...
  { name: 'Lagrange Memorial Library', url: 'https://lagrangelibrary.org/', eventsUrl: 'https://lagrangelibrary.org/', city: 'Lagrange', state: 'GA', zipCode: '00000', county: 'Troup', urlCollision: 'lagrangelibrary.org is IL, not GA' },
  ...
  { name: 'Oglethorpe County Library', url: 'https://www.lexingtonlibrary.org', eventsUrl: 'https://www.lexingtonlibrary.org/events', city: 'Lexington', state: 'GA', zipCode: '00000', county: 'Oglethorpe', urlCollision: 'lexingtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Nelle Brown Memorial Public Library', url: 'https://lyonslibrary.org/', eventsUrl: 'https://lyonslibrary.org/', city: 'Lyons', state: 'GA', zipCode: '00000', county: 'Toombs', urlCollision: 'lyonslibrary.org is IL, not GA' },
  { name: 'Middle Georgia Regional Library System', url: 'https://www.maconlibrary.org', eventsUrl: 'https://www.maconlibrary.org/events', city: 'Macon', state: 'GA', zipCode: '31201', county: 'Macon County', urlCollision: 'maconlibrary.org is MO, not GA' },
  ...
  { name: 'Lake Sinclair Library', url: 'https://milledgevillelibrary.org/', eventsUrl: 'https://milledgevillelibrary.org/calendar', city: 'Milledgeville', state: 'GA', zipCode: '00000', county: 'Baldwin', urlCollision: 'milledgevillelibrary.org is Milledgeville Public Library in ILLINOIS, not GA - live page shows 18 W. Fifth St, Milledgeville IL 61051, phone area code 815. There are two Milledgevilles and this host serves the wrong one'},
  { name: 'Monroe-Walton County Library', url: 'https://www.monroelibrary.org', eventsUrl: 'https://www.monroelibrary.org/events', city: 'Monroe', state: 'GA', zipCode: '00000', county: 'Monroe County', urlCollision: 'monroelibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Baker County', url: 'https://www.newtonlibrary.org', eventsUrl: 'https://www.newtonlibrary.org/events', city: 'Newton', state: 'GA', zipCode: '00000', county: 'Newton County', urlCollision: 'newtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Houston County Public Libraries System', url: 'https://www.perrylibrary.org/', eventsUrl: 'https://www.perrylibrary.org/calendar', city: 'Perry', state: 'GA', zipCode: '31069', county: 'Houston', urlCollision: 'perrylibrary.org is NC, not GA' },
  ...
  { name: 'Brooks County Public Library System', url: 'https://www.quitmanlibrary.org/', eventsUrl: 'https://www.quitmanlibrary.org/', city: 'Quitman', state: 'GA', zipCode: '31643', county: 'Quitman County', urlCollision: 'quitmanlibrary.org is TX, not GA' },
  { name: 'Parks Memorial Library', url: 'https://www.richlandlibrary.org/', eventsUrl: 'https://www.richlandlibrary.org/Calendar', city: 'Richland', state: 'GA', zipCode: '00000', county: 'Stewart', urlCollision: 'richlandlibrary.org is MI, not GA' },
  { name: 'Riverdale Branch Library', url: 'https://www.riverdalelibrary.org', eventsUrl: 'https://www.riverdalelibrary.org/events', city: 'Riverdale', state: 'GA', zipCode: '00000', county: 'Clayton', urlCollision: 'riverdalelibrary.org is NJ, not GA' },
  ...
  { name: 'Rossville Public Library', url: 'https://www.rossvillelibrary.org', eventsUrl: 'https://www.rossvillelibrary.org/events', city: 'Rossville', state: 'GA', zipCode: '00000', county: 'Walker', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  { name: 'Scottdale-Tobie Grant Branch', url: 'https://www.scottdalelibrary.org/', eventsUrl: 'https://www.scottdalelibrary.org/', city: 'Scottdale', state: 'GA', zipCode: '00000', county: 'DeKalb', urlCollision: 'scottdalelibrary.org is PA, not GA' },
  ...
  { name: 'Lewis A. Ray Library', url: 'https://www.smyrnalibrary.org', eventsUrl: 'https://www.smyrnalibrary.org/events', city: 'Smyrna', state: 'GA', zipCode: '00000', county: 'Cobb', urlCollision: 'smyrnalibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Hancock County Library', url: 'https://www.spartalibrary.org', eventsUrl: 'https://www.spartalibrary.org/events', city: 'Sparta', state: 'GA', zipCode: '00000', county: 'Hancock', urlCollision: 'spartalibrary.org is WI, not GA' },
