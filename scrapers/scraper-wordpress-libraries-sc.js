...
const LIBRARIES = [
  ...
  { name: 'Pickens County Library - Central-Clemson Branch Library', url: 'https://www.centrallibrary.org', eventsUrl: 'https://www.centrallibrary.org/events', city: 'Central', state: 'SC', zipCode: '29630', county: 'Pickens', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  // 2026-08-26: newberrylibrary.org is DEAD - resolves to 74.254.67.33, refuses both 443 and 80 - and was shared with FL. The real institution is Newberry County Library / Hal Kohn Memorial, 1100 Friend Street, Newberry SC 29108, ph 803-276-0854 - the zipCode matches. NOT repointed: its site is a legacy YouSeeMore ILS at youseemore.com/newberry whose calendar is calendar.asp, which a WordPress DOM extractor cannot read. Platform mismatch, so this is an OPEN GAP needing a different family, not a URL correction.
  { name: 'Hal Kohn Memorial Library', url: 'https://www.newberrylibrary.org', eventsUrl: 'https://www.newberrylibrary.org/events', city: 'Newberry', state: 'SC', zipCode: '29108', county: 'Newberry County', urlCollision: 'newberrylibrary.org is dead and was shared with FL; real site is youseemore.com/newberry, a YouSeeMore ILS calendar.asp, not WordPress' },
  ...
  { name: 'Oconee County Public Library - Seneca Branch Library', url: 'https://www.senecalibrary.org', eventsUrl: 'https://www.senecalibrary.org/events', city: 'Seneca', state: 'SC', zipCode: '29678', county: 'Oconee', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'Lexington County Library - Swansea', url: 'https://lexcolibrary.com', eventsUrl: 'https://lexcolibrary.libcal.com', city: 'Swansea', state: 'SC', zipCode: '29160', county: 'Lexington', urlCollision: "COVERED BY THE PARENT SYSTEM, verified 2026-09-08. This is a BRANCH of Lexington County Public Library, which is already configured in LibCal-SC at lexcolibrary.libcal.com and logged Found 10 events. That parent entry reads the whole system calendar, so branch events arrive through it and this WordPress entry only ever returned 0. Guarded rather than deleted so the branch keeps its audit row. NOT a coverage gap" },
