...
const LIBRARIES = [
  ...
  { name: 'West Jordan Library', url: 'https://www.westjordan.utah.gov/library', eventsUrl: 'https://www.westjordan.utah.gov/save-water-in-west-jordan/programs-and-incentives/', city: 'West Jordan', state: 'UT', zipCode: '84088', county: 'West Jordan County'},
...
module.exports = { scrapeGenericEvents, saveToDatabase, scrapeWordpressUTCloudFunction };
