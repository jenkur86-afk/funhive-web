...
const LIBRARIES = [
  ...
  { name: 'Bergenfield Free Public Library', url: 'https://www.bergenfieldlibrary.org/', eventsUrl: 'https://www.bergenfieldlibrary.org/calendar/', city: 'Bergenfield', state: 'NJ', zipCode: '07621', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10269 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 107 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Boonton Holmes Public Library', url: 'https://www.boontonlibrary.org', eventsUrl: 'https://www.boontonlibrary.org/events', city: 'Boonton', state: 'NJ', zipCode: '07005', county: 'Morris', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance boontonlibrary.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 53 items titled for this same library'},
  ...
  { name: 'Camden Free Public Library', url: 'https://www.camdenlibrary.org/', eventsUrl: 'https://www.camdenlibrary.org/', city: 'Camden', state: 'NJ', zipCode: '08103', county: 'Camden County', urlCollision: 'camdenlibrary.org is MI, not NJ' },
  ...
  { name: 'Clark Public Library', url: 'https://www.clarklibrary.org', eventsUrl: 'https://www.clarklibrary.org/events', city: 'Clark', state: 'NJ', zipCode: '07066', county: 'Union', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on clarkpl.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Clark Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Maurice M. Pine Free Public Library', url: 'https://www.fairlawnlibrary.org/', eventsUrl: 'https://www.fairlawnlibrary.org/calendar', city: 'Fair Lawn', state: 'NJ', zipCode: '07410', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10281 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 145 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Glen Ridge Free Public Library', url: 'https://www.glenridgelibrary.org/', eventsUrl: 'https://www.glenridgelibrary.org/', city: 'Glen Ridge', state: 'NJ', zipCode: '07028', county: 'Essex', urlCollision: 'publishes on bccls.libcal.com/calendar/glenridge cid 10286 - link taken from the library own page. Relocated to LibCal-NJ on 2026-08-27'},
  ...
  { name: 'Haddonfield Public Library', url: 'https://www.haddonfieldlibrary.org/', eventsUrl: 'https://www.haddonfieldlibrary.org/', city: 'Haddonfield', state: 'NJ', zipCode: '08033', county: 'Camden', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on haddonfield.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Haddonfield Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  // what it says: "Hamilton Township Public Library Schedule of Events", 44 items. A deliberately bogus
  ...
  { name: 'Hamilton Township Free Public Library', url: 'https://hamiltonnjpl.org', eventsUrl: 'https://hamiltonnjpl.org/events/', city: 'Hamilton', state: 'NJ', zipCode: '08619', county: 'Monmouth', urlCollision: 'relocated to Assabet-NH-MA 2026-09-09 - publishes on Assabet Interactive, which this scraper cannot read. Destination feed titles itself "Hamilton Township Public Library Schedule of Events" with 44 items'},
  ...
  { name: 'Haworth Municipal Library', url: 'https://www.haworthlibrary.org/', eventsUrl: 'https://www.haworthlibrary.org/', city: 'Haworth', state: 'NJ', zipCode: '07641', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10291 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 176 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Lambertville Free Public Library', url: 'https://www.lambertvillelibrary.org', eventsUrl: 'https://www.lambertvillelibrary.org/events', city: 'Lambertville', state: 'NJ', zipCode: '08530', county: 'Hunterdon', urlCollision: 'publishes on lambertvillelibrary.libcal.com - link taken from the library own page. Relocated to LibCal-NJ on 2026-08-27'},
  ...
  { name: 'Linwood Public Library', url: 'https://www.linwoodlibrary.org', eventsUrl: 'https://www.linwoodlibrary.org/events', city: 'Linwood', state: 'NJ', zipCode: '08221', county: 'Atlantic', urlCollision: "dead/hijacked domain, confirmed: dead-domain: the configured URL redirects to wordpress2.nekls.org, which serves KS, not NJ — a same-named town in another state, the classic guessed-{city}library.org failure; needs a correct URL or a guard Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Middletown Township Public Library', url: 'https://www.middletownlibrary.org', eventsUrl: 'https://www.middletownlibrary.org/events', city: 'Middletown', state: 'NJ', zipCode: '07748', county: 'Monmouth', urlCollision: 'middletownlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'New Milford Public Library', url: 'https://newmilfordlibrary.org/', eventsUrl: 'https://newmilfordlibrary.org/', city: 'New Milford', state: 'NJ', zipCode: '07646', county: 'Bergen', urlCollision: 'newmilfordlibrary.org is CT, not NJ' },
  { name: 'New Providence Memorial Library', url: 'https://www.newprovidencelibrary.org/', eventsUrl: 'https://www.newprovidencelibrary.org/', city: 'New Providence', state: 'NJ', zipCode: '07974', county: 'Union', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  { name: 'Sussex County Library', url: 'https://www.newtonlibrary.org', eventsUrl: 'https://www.newtonlibrary.org/events', city: 'Newton', state: 'NJ', zipCode: '07860', county: 'Sussex', urlCollision: 'newtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Norwood Public Library', url: 'https://norwoodlibrary.org/', eventsUrl: 'https://norwoodlibrary.org/', city: 'Norwood', state: 'NJ', zipCode: '07648', county: 'Bergen', urlCollision: 'norwoodlibrary.org is MA, not NJ' },
  ...
  { name: 'Old Tappan Free Public Library', url: 'https://www.oldtappanlibrary.com/', eventsUrl: 'https://www.oldtappanlibrary.com/calendar', city: 'Old Tappan', state: 'NJ', zipCode: '07675', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10317 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 130 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Plainsboro Free Public Library', url: 'https://www.plainsborolibrary.org', eventsUrl: 'https://www.plainsborolibrary.org/events', city: 'Plainsboro', state: 'NJ', zipCode: '08536', county: 'Middlesex', urlCollision: "NOT RELOCATED, and deliberately so - checked 2026-09-07. The library does publish on LibCal (plainsborolibrary.libcal.com returns HTTP 200 titled for this library), but that tenant serves NO CALENDAR: /calendar, /calendar/events, /calendar?t=d, /calendar/?cid=-1 and /events all return HTTP 404 \"Whoops! - LibCal\", and the root is a landing page with zero events. A LibCal-* entry was drafted and REMOVED before it shipped, because it would have produced 0 rows while looking like a fix. OPEN COVERAGE GAP awaiting a working calendar URL" },
  ...
  { name: 'Ridgefield Free Public Library', url: 'https://www.ridgefieldpubliclibrary.com', eventsUrl: 'https://www.ridgefieldpubliclibrary.com', city: 'Ridgefield', state: 'NJ', zipCode: '07657', county: 'Bergen', urlCollision: 'publishes on bccls.libcal.com cid 10324 - link taken from the library own page, confirmed NJ by 527 Morse Avenue Ridgefield NJ 07657 and area code 201, not Ridgefield CT. Relocated to LibCal-NJ on 2026-08-27'},
  { name: 'Ridgewood Public Library', url: 'https://ridgewoodlibrary.org/', eventsUrl: 'https://ridgewoodlibrary.org/', city: 'Ridgewood', state: 'NJ', zipCode: '07450', county: 'Bergen', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance ridgewoodlibrary.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 123 items titled for this same library'},
  ...
  { name: 'Salem Free Public Library', url: 'https://www.salemlibrary.org', eventsUrl: 'https://www.salemlibrary.org/events', city: 'Salem', state: 'NJ', zipCode: '08079', county: 'Salem County', urlCollision: 'salemlibrary.org is OR, not NJ' },
  ...
  { name: 'Secaucus Free Public Library', url: 'https://www.secaucuslibrary.org', eventsUrl: 'https://www.secaucuslibrary.org/events', city: 'Secaucus', state: 'NJ', zipCode: '07094', county: 'Hudson', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10333 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 80 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Sparta Public Library', url: 'https://www.spartalibrary.org', eventsUrl: 'https://www.spartalibrary.org/events', city: 'Sparta', state: 'NJ', zipCode: '07871', county: 'Sussex', urlCollision: 'spartalibrary.org is WI, not NJ' },
  ...
  { name: 'Stratford Public Library', url: 'https://www.stratfordlibrary.org', eventsUrl: 'https://www.stratfordlibrary.org/events', city: 'Stratford', state: 'NJ', zipCode: '08084', county: 'Camden', urlCollision: 'stratfordlibrary.org is CT, not NJ' },
  { name: 'Summit Free Public Library', url: 'https://www.summitlibrary.org/', eventsUrl: 'https://www.summitlibrary.org/', city: 'Summit', state: 'NJ', zipCode: '07901', county: 'Union', urlCollision: 'publishes on summitlibrary.libcal.com - link taken from the library own page, confirmed by 75 Maple Street Summit NJ 07901. Relocated to LibCal-NJ on 2026-08-27'},
  ...
  { name: 'Tenafly Free Public Library', url: 'https://www.tenaflylibrary.org/', eventsUrl: 'https://www.tenaflylibrary.org/calendar', city: 'Tenafly', state: 'NJ', zipCode: '07670', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=9537 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 245 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  { name: 'Dwight D. Eisenhower Library', url: 'https://www.totowalibrary.org', eventsUrl: 'https://www.totowalibrary.org/events', city: 'Totowa', state: 'NJ', zipCode: '07512', county: 'Passaic', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'West Orange Free Public Library', url: 'https://www.westorangelibrary.org/', eventsUrl: 'https://www.westorangelibrary.org/', city: 'West Orange', state: 'NJ', zipCode: '07052', county: 'Essex', urlCollision: 'publishes on bccls.libcal.com/calendar/westorange cid 10341 - link taken from the library own page. Relocated to LibCal-NJ on 2026-08-27'},
  ...
  { name: 'Westwood Free Public Library', url: 'https://www.westwoodlibrary.org', eventsUrl: 'https://www.westwoodlibrary.org/events', city: 'Westwood', state: 'NJ', zipCode: '07675', county: 'Bergen', urlCollision: 'westwoodlibrary.org is MA, not NJ' },
  ...
  { name: 'Monroe Twp Public Library-Gloucester', url: 'https://www.williamstownlibrary.org', eventsUrl: 'https://www.williamstownlibrary.org/events', city: 'Williamstown', state: 'NJ', zipCode: '08094', county: 'Gloucester', urlCollision: 'williamstownlibrary.org is NY, not NJ' },
  ...
  { name: 'Wyckoff Free Public Library', url: 'https://www.wyckofflibrary.org', eventsUrl: 'https://www.wyckofflibrary.org/events', city: 'Wyckoff', state: 'NJ', zipCode: '07481', county: 'Bergen', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant bccls.libcal.com, now configured in LibCal-* as ?cid=10344 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 145 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" }
];
