...
async function main() {
  ...
  await scrapeBiblioCommons{{state}}();
...
module.exports = { scrapeBiblioCommonsEvents, saveToDatabase, scrapeBiblioCommons{{state}} };
