...
/**
 * CALIFORNIA MACARONI KID SCRAPER
 *
 * Scrapes events from 34 California Macaroni Kid sites
 *
 * Coverage: Major cities and counties across California
 *
 * Usage:
 *   node scraper-macaroni-ca.js          # Test mode (5 sites)
 *   node scraper-macaroni-ca.js --full   # Production (all 34 sites)
 */
...
// All 34 California Macaroni Kid Sites
const CALIFORNIA_MK_SITES = [
  { url: 'https://alisoviejo.macaronikid.com', name: 'Aliso Viejo-Laguna Beach-Laguna Niguel', county: 'Orange' },
  { url: 'https://almadenvalley.macaronikid.com', name: 'Almaden Valley-Los Gatos', county: 'Santa Clara' },
  { url: 'https://anaheim.macaronikid.com', name: 'Anaheim-Buena Park', county: 'Orange' },
  { url: 'https://auburnca.macaronikid.com', name: 'Auburn', county: 'Placer' },
  { url: 'https://beverlyhills.macaronikid.com', name: 'Beverly Hills', county: 'Los Angeles' },
  { url: 'https://brentwood.macaronikid.com', name: 'Brentwood', county: 'Contra Costa' },
  { url: 'https://burbank.macaronikid.com', name: 'Burbank-North Hollywood-Sunland', county: 'Los Angeles' },
  { url: 'https://camarillo.macaronikid.com', name: 'Camarillo-Ventura-Oxnard', county: 'Ventura' },
  { url: 'https://chico.macaronikid.com', name: 'Chico', county: 'Butte' },
  { url: 'https://chinohills.macaronikid.com', name: 'Chino Hills-Chino-Diamond Bar', county: 'San Bernardino' },
  { url: 'https://culvercity.macaronikid.com', name: 'Culver City', county: 'Los Angeles' },
  { url: 'https://folsom.macaronikid.com', name: 'Folsom-El Dorado Hills', county: 'El Dorado' },
  { url: 'https://fremont.macaronikid.com', name: 'Fremont-Newark-Union City', county: 'Alameda' },
  { url: 'https://glendale.macaronikid.com', name: 'Glendale-La Crescenta-Montrose', county: 'Los Angeles' },
  { url: 'https://hayward.macaronikid.com', name: 'Hayward-San Leandro-Castro Valley', county: 'Alameda' },
  { url: 'https://irvine.macaronikid.com', name: 'Irvine', county: 'Orange' },
  { url: 'https://lakewoodca.macaronikid.com', name: 'Lakewood-Cerritos-Cypress', county: 'Los Angeles' },
  { url: 'https://lodi.macaronikid.com', name: 'Lodi', county: 'San Joaquin' },
  { url: 'https://modesto.macaronikid.com', name: 'Modesto', county: 'Stanislaus' },
  { url: 'https://mountainhouse.macaronikid.com', name: 'Mountain House-Manteca-Tracy', county: 'San Joaquin' },
  { url: 'https://pasadena.macaronikid.com', name: 'Pasadena', county: 'Los Angeles' },
  { url: 'https://pleasanton.macaronikid.com', name: 'Pleasanton-Livermore-Dublin', county: 'Alameda' },
  { url: 'https://ranchocucamonga.macaronikid.com', name: 'Rancho Cucamonga', county: 'San Bernardino' },
  { url: 'https://redondobeach.macaronikid.com', name: 'Redondo-Hermosa-Manhattan', county: 'Los Angeles' },
  { url: 'https://riverbank.macaronikid.com', name: 'Riverbank-Oakdale-Escalon', county: 'Stanislaus' },
  { url: 'https://rosevilleca.macaronikid.com', name: 'Roseville-Rocklin-Lincoln', county: 'Placer' },
  { url: 'https://downtownsacramento.macaronikid.com', name: 'Sacramento', county: 'Sacramento' },
  { url: 'https://santaclarita.macaronikid.com', name: 'Santa Clarita Valley', county: 'Los Angeles' },
  { url: 'https://santamonica.macaronikid.com', name: 'Santa Monica', county: 'Los Angeles' },
  { url: 'https://stockton.macaronikid.com', name: 'Stockton', county: 'San Joaquin' },
  { url: 'https://temecula.macaronikid.com', name: 'Temecula-Murrieta-French Valley', county: 'Riverside' },
  { url: 'https://torrance.macaronikid.com', name: 'Torrance', county: 'Los Angeles' },
  { url: 'https://upland.macaronikid.com', name: 'Upland-Claremont-La Verne', county: 'San Bernardino' },
  { url: 'https://walnut.macaronikid.com', name: 'Walnut-Rowland Heights', county: 'Los Angeles' }
];
...
async function geocodeAddress(address, city, zipCode) {
  ...
  if (cleaned !== address) {
    result = await tryGeocode(`${cleaned}, ${city}, CA ${zipCode}`);
    if (result) return result;
  }

  const streetOnly = cleaned.split(',')[0];
  return await tryGeocode(`${streetOnly}, CA ${zipCode}`);
}
  ...
  try {
    ...
    return await page.evaluate(() => {
      ...
      if (eventsIndex > -1) {
        ...
        if (idx < lines.length) { const cityZipMatch = lines[idx].match(/^([\w\s]+)\s+CA\s+(\d{5})/); if (cityZipMatch) { result.city = cityZipMatch[1].trim(); result.zipCode = cityZipMatch[2]; }}
      }
  ...
  try {
    ...
    for (const url of eventUrls) {
      ...
      if (coords) {
        ...
        if (!coords) {
          const countyCentroid = getCountyCentroid(site.county, 'CA');
          if (countyCentroid) {
      ...
      const eventDoc = {
        ...
        metadata: {
          source: 'Macaroni Kid California Scraper',
...
async function scrapeMacaroniKidCalifornia() {
  const fullMode = true; // PRODUCTION: All sites
  console.log('🥕 CALIFORNIA MACARONI KID SCRAPER\n' + '='.repeat(60));
  const sitesToScrape = fullMode ? CALIFORNIA_MK_SITES : CALIFORNIA_MK_SITES.slice(0, 5);
  ...
  console.log('\n' + '='.repeat(60));
  console.log('✅ CALIFORNIA MACARONI KID SCRAPER COMPLETE!');
  console.log(`📊 Summary:`);
  ...
  await logScraperResult('Macaroni Kid CA', {
    new: imported,
    duplicates: skipped,
    errors: failed
  }, { state: 'CA', source: 'macaroni-kid' });

  return { imported, failed };
}

if (require.main === module) {
  scrapeMacaroniKidCalifornia()
    .then(() => process.exit(0))
    .catch(error => {
...
module.exports = { scrapeMacaroniKidCalifornia };
