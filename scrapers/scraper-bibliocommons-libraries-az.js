 ...
 * Libraries: [
  {
    ...
    "eventsUrl": "https://pima.bibliocommons.com/events"
  }
]
 */

const LIBRARIES = [
  { name: "Pima County Public Library", url: "https://www.library.pima.gov", platform: "bibliocommons", eventsUrl: "https://pima.bibliocommons.com/events", city: "Tucson", state: "AZ", zipCode: "85701", county: "Pima" }
];

const SCRAPER_NAME = 'bibliocommons-AZ';
...
async function main() {
  console.log(`\n╔════════════════════════════════════════════════════════╗`);
  console.log(`║  BiblioCommons Scraper - AZ (${LIBRARIES.length} libraries)  ║`);
  console.log(`╚════════════════════════════════════════════════════════╝\n`);
  ...
  await logScraperResult('Bibliocommons Libraries AZ', {
