 ...
 * Libraries: [
  {
    ...
    "eventsUrl": "https://www.dclibrary.org/events"
  }
]
 */

const LIBRARIES = [
  { name: "DC Public Library", url: "https://www.dclibrary.org", platform: "bibliocommons", eventsUrl: "https://www.dclibrary.org/events", city: "Washington", state: "DC", zipCode: "20001", county: "District of Columbia" }
];

const SCRAPER_NAME = 'bibliocommons-DC';
...
async function main() {
  console.log(`\n╔════════════════════════════════════════════════════════╗`);
  console.log(`║  BiblioCommons Scraper - DC (${LIBRARIES.length} libraries)  ║`);
  console.log(`╚════════════════════════════════════════════════════════╝\n`);
  ...
  await logScraperResult('Bibliocommons Libraries DC', {
