...
const LIBRARIES = [
  ...
  { name: 'Claremont Branch Library', url: 'https://www.catawbacountync.gov/county-services/library/', eventsUrl: 'https://www.catawbacountync.gov/county-services/library/calendar-of-events/', city: 'Claremont', state: 'NC', zipCode: '00000', county: 'Catawba County', urlCollision: 'events are in a cross-origin Google Calendar iframe, unreadable by a DOM extractor. The whole Catawba system publishes ONE calendar and the ICS LOCATION names the branch, so Claremont arrives as its own venue under GoogleCalendar-NC. Relocated 2026-09-06, proven live at 167 rows across 12 branch venues'},
  ...
  { name: 'Mooresville Public Library', url: 'https://www.mooresvillelibrary.org/', eventsUrl: 'https://www.mooresvillelibrary.org/', city: 'Mooresville', state: 'NC', zipCode: '28115', county: 'Iredell', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on mooresvillenc.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Mooresville Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Catawba County Library', url: 'https://www.catawbacountync.gov/county-services/library/', eventsUrl: 'https://www.catawbacountync.gov/county-services/library/calendar-of-events/', city: 'Newton', state: 'NC', zipCode: '28658', county: 'Catawba County', urlCollision: 'events are in a cross-origin Google Calendar iframe, unreadable by a DOM extractor. Relocated to GoogleCalendar-NC 2026-09-06, proven live at 167 rows across 12 branch venues'},
