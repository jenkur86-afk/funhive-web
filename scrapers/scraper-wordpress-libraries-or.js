...
const LIBRARIES = [
  ...
  { name: 'Salem Public Library', url: 'https://www.cityofsalem.net/', eventsUrl: 'https://www.cityofsalem.net/community/library', city: 'Salem', state: 'OR', zipCode: '97301', county: 'Salem County'},
  // Regional Libraries
  ...
  { name: 'Clackamas County Library', url: 'https://www.clackamas.us/', eventsUrl: 'https://www.clackamas.us/events', city: 'Oregon City', state: 'OR', zipCode: '97045', county: 'Oregon City County'},
  ...
  { name: 'Springfield Public Library', url: 'https://wheremindsgrow.org/', eventsUrl: 'https://wheremindsgrow.org/events', city: 'Springfield', state: 'OR', zipCode: '97477', county: 'Springfield County'},
  { name: 'Tigard Public Library', url: 'https://www.tigard-or.gov/', eventsUrl: 'https://www.tigard-or.gov/your-government/departments/library', city: 'Tigard', state: 'OR', zipCode: '97223', county: 'Tigard County'},
  ...
  { name: 'Hillsboro Public Library', url: 'https://www.hillsboro-oregon.gov/', eventsUrl: 'https://www.hillsboro-oregon.gov/our-city/event-calendar', city: 'Hillsboro', state: 'OR', zipCode: '97123', county: 'Hillsboro County'},
  ...
  { name: 'Lake Oswego Public Library', url: 'https://www.ci.oswego.or.us/', eventsUrl: 'https://www.ci.oswego.or.us/calendar?og_group_ref_target_id=13', city: 'Lake Oswego', state: 'OR', zipCode: '97034', county: 'Lake Oswego County'},
  ...
  { name: 'Newberg Public Library', url: 'https://www.newbergoregon.gov/', eventsUrl: 'https://www.newbergoregon.gov/library/', city: 'Newberg', state: 'OR', zipCode: '97132', county: 'Newberg County'},
  { name: 'Astoria Public Library', url: 'https://www.astoria.gov/', eventsUrl: 'https://www.astoria.gov/calendar?deptid=6', city: 'Astoria', state: 'OR', zipCode: '97103', county: 'Astoria County'},
