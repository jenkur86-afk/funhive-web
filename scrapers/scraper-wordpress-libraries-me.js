...
const LIBRARIES = [
  ...
  { name: 'Portland Public Library', url: 'https://www.portlandlibrary.org', eventsUrl: 'https://www.portlandlibrary.org/events', city: 'Portland', state: 'ME', zipCode: '04101', county: 'Cumberland', urlCollision: 'already covered by LibraryMarket-ME-NH-MA, verified 2026-09-07 - this library publishes on portlandme.librarycalendar.com, which a WordPress DOM extractor cannot read, and scraper-librarymarket-libraries-me-nh-ma.js already carries that exact eventsUrl. NOT taken on trust: LIBRARY-SITE-AUDIT.md records LibraryMarket-ME-NH-MA finding 22 and 23 events for it on separate cycles, which is real output rather than a config that merely exists. Guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Kennebunk Free Library', url: 'https://kennebunklibrary.org/', eventsUrl: 'https://kennebunklibrary.org/calendar/', city: 'Kennebunk', state: 'ME', zipCode: '04043', county: 'York', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance kennebunklibrary.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 63 items titled for this same library'},
  ...
  { name: 'Brownville Public Library', url: 'https://www.brownvillelibrary.org', eventsUrl: 'https://www.brownvillelibrary.org/events', city: 'Brownville', state: 'ME', zipCode: '04414', county: 'Piscataquis', urlCollision: 'brownvillelibrary.org is NY, not ME' },
  ...
  { name: 'Brown Memorial Library - Clinton', url: 'https://www.clintonlibrary.org', eventsUrl: 'https://www.clintonlibrary.org/events', city: 'Clinton', state: 'ME', zipCode: '04927', county: 'Kennebec', urlCollision: 'clintonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Louise Clements Library', url: 'https://www.cutlerlibrary.org/', eventsUrl: 'https://www.cutlerlibrary.org/', city: 'Cutler', state: 'ME', zipCode: '04626', county: 'Washington', urlCollision: 'cutlerlibrary.org is VT, not ME' },
  ...
  { name: 'Lebanon Town Library', url: 'https://lebanonlibrary.org/', eventsUrl: 'https://lebanonlibrary.org/', city: 'Lebanon', state: 'ME', zipCode: '04027', county: 'York', urlCollision: 'lebanonlibrary.org is OH, not ME' },
  ...
  { name: 'Mercer - Shaw Library', url: 'https://www.mercerlibrary.org', eventsUrl: 'https://www.mercerlibrary.org/events', city: 'Mercer', state: 'ME', zipCode: '00000', county: 'Somerset', urlCollision: 'mercerlibrary.org is OH, not ME' },
  ...
  { name: 'Monroe Community Library', url: 'https://www.monroelibrary.org', eventsUrl: 'https://www.monroelibrary.org/events', city: 'Monroe', state: 'ME', zipCode: '04951', county: 'Waldo', urlCollision: 'monroelibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Sherman Public Library', url: 'https://www.shermanlibrary.org/', eventsUrl: 'https://www.shermanlibrary.org/', city: 'Sherman', state: 'ME', zipCode: '04776', county: 'Aroostook', urlCollision: 'shermanlibrary.org is CT, not ME' },
  ...
  { name: 'Stonington Public Library', url: 'https://www.stoningtonlibrary.org/', eventsUrl: 'https://www.stoningtonlibrary.org/', city: 'Stonington', state: 'ME', zipCode: '04681', county: 'Hancock', urlCollision: 'stoningtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Frenchmans Bay Library', url: 'https://www.sullivanil.us/', eventsUrl: 'https://www.sullivanil.us/departments/library/index.php', city: 'Sullivan', state: 'ME', zipCode: '04664', county: 'Hancock', urlCollision: 'sullivanil.us is IL, not ME' },
  ...
  { name: 'York Public Library', url: 'https://yorklibrary.org/', eventsUrl: 'https://yorklibrary.org/', city: 'York', state: 'ME', zipCode: '03909', county: 'York County', urlCollision: 'yorklibrary.org is NE, not ME' }
