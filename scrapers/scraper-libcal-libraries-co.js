 ...
 * Libraries: [
  {
    ...
    "platform": "libcal",
    "eventsUrl": "https://arapahoelibraries.org/events"
  },
  {
    "name": "Jefferson County Public Library",
    "url": "https://jeffcolibrary.org",
    "platform": "libcal",
    "eventsUrl": "https://jeffcolibrary.org/events"
  }
]
 */

const LIBRARIES = [
  { name: "Arapahoe Libraries", url: "https://arapahoelibraries.org", platform: "libcal", eventsUrl: "https://arapahoelibraries.org/events", city: "Englewood", state: "CO", zipCode: "80112", county: "Arapahoe" },
  { name: "Jefferson County Public Library", url: "https://jeffcolibrary.org", platform: "libcal", eventsUrl: "https://jeffcolibrary.org/events", city: "Lakewood", state: "CO", zipCode: "80226", county: "Jefferson" }
];

const SCRAPER_NAME = 'libcal-CO';
...
async function main() {
  console.log(`\n╔════════════════════════════════════════════════════════╗`);
  console.log(`║  LibCal Scraper - CO (${LIBRARIES.length} libraries)  ║`);
  console.log(`╚════════════════════════════════════════════════════════╝\n`);
  ...
  await logScraperResult('Libcal Libraries CO', {
