 ...
 * Libraries: [
  {
    ...
    "eventsUrl": "https://dallaslibrary.librarymarket.com"
  }
]
 */

const LIBRARIES = [
  { name: "Dallas Public Library", url: "https://dallaslibrary.org", platform: "librarymarket", eventsUrl: "https://dallaslibrary.librarymarket.com", city: "Dallas", state: "TX", zipCode: "75201", county: "Dallas" }
];
...
async function main() {
  ...
  await logScraperResult('Librarymarket Libraries TX', {
