...
const LIBRARIES = [
  ...
  { name: 'Collinsville Public Library', url: 'https://www.collinsvillelibrary.org', eventsUrl: 'https://www.collinsvillelibrary.org/events', city: 'Collinsville', state: 'AL', zipCode: '35961', county: 'DeKalb', urlCollision: "dead/hijacked domain, confirmed: dead-domain - collinsvillelibrary.org 307-redirects to a GoDaddy forsale parked page, no library site Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Stevenson Public Library', url: 'https://www.stevensonlibrary.org', eventsUrl: 'https://www.stevensonlibrary.org/events', city: 'Stevenson', state: 'AL', zipCode: '35772', county: 'Jackson', urlCollision: "dead/hijacked domain, confirmed: dead-endpoint: HTTP 404 on the configured URL [redirects to stevenson.libguides.com] Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Wilsonville - Vernice Stoudenmire Library', url: 'https://www.wilsonvillelibrary.org', eventsUrl: 'https://www.wilsonvillelibrary.org/events', city: 'Wilsonville', state: 'AL', zipCode: '35186', county: 'Shelby', urlCollision: 'wilsonvillelibrary.org is the Wilsonville Public Library in OREGON, not AL - live page shows 29799 SW Town Center Loop E, Wilsonville OR 97070, phone area code 503'},
