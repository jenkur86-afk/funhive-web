...
const LIBRARIES = [
  ...
  { name: 'Avalon Public Library', url: 'https://avalonlibrary.org/', eventsUrl: 'https://avalonlibrary.org/', city: 'Avalon', state: 'PA', zipCode: '15202', county: 'Allegheny', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on avalonpl.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Avalon Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Beaver County Bookmobile Schedule', url: 'https://www.beaverfallslibrary.org', eventsUrl: 'https://www.beaverfallslibrary.org/events', city: 'Beaver Falls', state: 'PA', zipCode: '15010', county: 'Beaver', urlCollision: 'beaverfallslibrary.org is NY, not PA' },
  ...
  { name: 'Bethel-Tulpehocken Public Library', url: 'https://www.bethellibrary.org', eventsUrl: 'https://www.bethellibrary.org/events', city: 'Bethel', state: 'PA', zipCode: '19507', county: 'Berks', urlCollision: 'bethellibrary.org is CT, not PA' },
  ...
  { name: 'Bethlehem Area Public Library', url: 'https://www.bethlehemlibrary.org', eventsUrl: 'https://www.bethlehemlibrary.org/events', city: 'Bethlehem', state: 'PA', zipCode: '18018', county: 'Northampton', urlCollision: 'bethlehemlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Butler Area Public Library', url: 'https://www.butlerlibrary.org', eventsUrl: 'https://www.butlerlibrary.org/events', city: 'Butler', state: 'PA', zipCode: '16001', county: 'Butler County', urlCollision: 'butlerlibrary.org is NJ, not PA' },
  ...
  { name: 'Bosler Free Library', url: 'https://www.carlislelibrary.org', eventsUrl: 'https://www.carlislelibrary.org/events', city: 'Carlisle', state: 'PA', zipCode: '17013', county: 'Cumberland', urlCollision: 'carlislelibrary.org is IA, not PA' },
  ...
  { name: 'Community Library Of Castle Shannon', url: 'https://castleshannonlibrary.org/', eventsUrl: 'https://castleshannonlibrary.org/', city: 'Castle Shannon', state: 'PA', zipCode: '15234', county: 'Allegheny', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on castleshannon.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Community Library of Castle Shannon and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  { name: 'Chester Springs Library', url: 'https://www.chesterspringslibrary.org/', eventsUrl: 'https://www.chesterspringslibrary.org/', city: 'Chester Springs', state: 'PA', zipCode: '19425', county: 'Chester', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant ccls.libcal.com, now configured in LibCal-* as ?cid=13406 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 119 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Clairton Public Library', url: 'https://clairtonlibrary.org/', eventsUrl: 'https://clairtonlibrary.org/', city: 'Clairton', state: 'PA', zipCode: '15025', county: 'Allegheny', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on clairton.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Clairton Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Cooperstown Public Library', url: 'https://www.cooperstownlibrary.org', eventsUrl: 'https://www.cooperstownlibrary.org/events', city: 'Cooperstown', state: 'PA', zipCode: '16317', county: 'Venango', urlCollision: 'cooperstownlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  { name: 'Coraopolis Memorial Library', url: 'https://coraopolislibrary.org/', eventsUrl: 'https://coraopolislibrary.org/', city: 'Coraopolis', state: 'PA', zipCode: '15108', county: 'Allegheny', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on coraopolis.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Coraopolis Memorial Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Erie County Public Library', url: 'https://erielibrary.org/', eventsUrl: 'https://erielibrary.org/', city: 'Erie', state: 'PA', zipCode: '16507', county: 'Erie County', urlCollision: "RELOCATED 2026-09-08 to LibCal-PA at events.erielibrary.org. Found by following the library own Events Calendar link - the LibCal instance is OFF-HOST, so no path guess against erielibrary.org could have reached it. Identity confirmed from the page: title LibCal - Erie County Public Library, ZIPs PA 16508/16504/16503, phone 814-451-6935 (814 is Erie PA). 125 event elements live. A WordPress DOM scraper cannot read LibCal. NOT a coverage gap" },
  ...
  { name: 'Bucks County Free Library - Fallsington Library', url: 'https://www.fallsingtonlibrary.org', eventsUrl: 'https://www.fallsingtonlibrary.org/events', city: 'Fallsington', state: 'PA', zipCode: '19054', county: 'Bucks', urlCollision: "NOT RELOCATED, checked 2026-09-08. The library publishes on calendar.buckslib.org, but that tenant has NO PER-BRANCH FILTER: cid=3891 is the category \"Library Programs\" not a branch, cid=2279 returns HTTP 404, and cm=2279, a bogus cm and no filter at all every one returns a set spanning ALL EIGHT Bucks County branches (Bensalem, Doylestown, Fallsington, Langhorne, Levittown, Perkasie, Quakertown, Yardley). Relocating would import all eight under this branch name - the same defect as delcolibraries.libcal.com. OPEN COVERAGE GAP until a per-branch URL exists" },
  ...
  { name: 'Borough Of Folcroft Public Library', url: 'https://www.folcroftlibrary.org', eventsUrl: 'https://www.folcroftlibrary.org/events', city: 'Folcroft', state: 'PA', zipCode: '19032', county: 'Delaware', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'Glenolden Library', url: 'https://www.glenoldenlibrary.org', eventsUrl: 'https://www.glenoldenlibrary.org/events', city: 'Glenolden', state: 'PA', zipCode: '19036', county: 'Delaware', urlCollision: "dead/hijacked domain, confirmed: dead-endpoint: HTTP 522 on the configured URL [redirects to chromewebdata] Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Hoyt Library', url: 'https://www.kingstonlibrary.org', eventsUrl: 'https://www.kingstonlibrary.org/events', city: 'Kingston', state: 'PA', zipCode: '18704', county: 'Luzerne', urlCollision: 'kingstonlibrary.org is NY, not PA' },
  ...
  { name: 'Northern Wayne Community Library', url: 'https://lakewoodlibrary.org/', eventsUrl: 'https://lakewoodlibrary.org/events/event/', city: 'Lakewood', state: 'PA', zipCode: '18439', county: 'Erie', urlCollision: 'lakewoodlibrary.org is NY, not PA' },
  ...
  { name: 'Lebanon Community Library', url: 'https://lebanonlibrary.org/', eventsUrl: 'https://lebanonlibrary.org/', city: 'Lebanon', state: 'PA', zipCode: '17046', county: 'Lebanon County', urlCollision: 'lebanonlibrary.org is OH, not PA' },
  ...
  { name: 'Lilly Washington Pub Library', url: 'https://www.lillylibrary.org/', eventsUrl: 'https://www.lillylibrary.org/', city: 'Lilly', state: 'PA', zipCode: '15938', county: 'Cambria', urlCollision: "lillylibrary.org is MA, not PA - live page addresses print MA, title \"Lilly Library Florence MA\". Proven 2026-09-06" },
  ...
  { name: 'Martinsburg Community Library', url: 'https://www.martinsburglibrary.org', eventsUrl: 'https://www.martinsburglibrary.org/events', city: 'Martinsburg', state: 'PA', zipCode: '16662', county: 'Blair', urlCollision: 'martinsburglibrary.org is NY, not PA' },
  { name: 'Carnegie Library Of Mckeesport', url: 'https://mckeesportlibrary.org/', eventsUrl: 'https://mckeesportlibrary.org/', city: 'Mckeesport', state: 'PA', zipCode: '15132', county: 'Allegheny', urlCollision: 'publishes on mckeesport.librarycalendar.com - link taken from the library own page, PA confirmed by ZIP 15132 and area code 412. Relocated to LibraryCalendar-Libraries on 2026-08-27. The acl.bibliocommons.com link on that page is the Allegheny County CATALOG, not its events'},
  ...
  { name: 'Francis J. Catania Law Library', url: 'https://www.medialibrary.org', eventsUrl: 'https://www.medialibrary.org/events', city: 'Media', state: 'PA', zipCode: '19063', county: 'Delaware', urlCollision: "dead/hijacked domain, confirmed: dead-domain: the configured URL redirects to forsale.godaddy.com, a GoDaddy parked \"domain for sale\" page — the library no longer controls this domain, so extraction can never succeed here and the entry needs a correct URL or a guard Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  { name: 'Mercer Area Library', url: 'https://www.mercerlibrary.org', eventsUrl: 'https://www.mercerlibrary.org/events', city: 'Mercer', state: 'PA', zipCode: '16137', county: 'Mercer County', urlCollision: 'mercerlibrary.org is OH, not PA' },
  ...
  { name: 'Middletown Public Library', url: 'https://www.middletownlibrary.org', eventsUrl: 'https://www.middletownlibrary.org/events', city: 'Middletown', state: 'PA', zipCode: '17057', county: 'Dauphin', urlCollision: 'middletownlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  // 2026-08-27: PLATFORM MISMATCH. Its own /events path 404s; the instance is monroeville.librarycalendar.com, titled "Upcoming Events | Monroeville Public Library".
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Monroeville Public Library', url: 'https://www.monroevillelibrary.org', eventsUrl: 'https://www.monroevillelibrary.org/events', city: 'Monroeville', state: 'PA', zipCode: '15146', county: 'Allegheny', urlCollision: 'platform mismatch - publishes on monroeville.librarycalendar.com; relocated to LibraryCalendar-Libraries 2026-08-27' },
  // URL corrected 2026-08-26 (was montgomerylibrary.org, a dead host shared with NY/MA/WV). montgomerylib.org 301s to maplpa.org, which prints "1 South Main Street Montgomery, PA 17752" and 570-547-6212 - the zipCode matches this entry exactly, which is what makes it live-page evidence rather than a name guess. county also corrected: Montgomery PA 17752 is in LYCOMING county (it is a member of the Lycoming County Library System); the old "Montgomery County" resolved to a centroid near Philadelphia, about 150 miles away.
  { name: 'Montgomery Area Public Library', url: 'https://maplpa.org', eventsUrl: 'https://maplpa.org/programs-information/', city: 'Montgomery', state: 'PA', zipCode: '17752', county: 'Lycoming'},
  ...
  { name: 'Pratt Memorial Library', url: 'https://newmilfordlibrary.org/', eventsUrl: 'https://newmilfordlibrary.org/', city: 'New Milford', state: 'PA', zipCode: '18834', county: 'Susquehanna', urlCollision: 'newmilfordlibrary.org is CT, not PA' },
  ...
  { name: 'Priestley Forsyth Memorial Library', url: 'https://www.northumberlandlibrary.org/', eventsUrl: 'https://www.northumberlandlibrary.org/', city: 'Northumberland', state: 'PA', zipCode: '17857', county: 'Northumberland County', urlCollision: "northumberlandlibrary.org is a SQUATTED DOMAIN, not a library - it now serves an Indonesian gambling site titled \"Situs Toto Makto\". Proven 2026-09-06; do not re-point, find the real URL" },
  { name: 'Norwood Public Library', url: 'https://norwoodlibrary.org/', eventsUrl: 'https://norwoodlibrary.org/', city: 'Norwood', state: 'PA', zipCode: '19074', county: 'Delaware', urlCollision: 'norwoodlibrary.org is MA, not PA' },
  ...
  { name: 'Ralston Link', url: 'https://www.ralstonlibrary.org/', eventsUrl: 'https://www.ralstonlibrary.org/calendar', city: 'Ralston', state: 'PA', zipCode: '17763', county: 'Lycoming', urlCollision: "ralstonlibrary.org is NE, not PA - live page is Baright Public Library, Ralston NEBRASKA. Two Ralstons; this host serves the wrong one. Proven 2026-09-06" },
  { name: 'Berks County Public Libraries', url: 'https://www.readinglibrary.org', eventsUrl: 'https://www.readinglibrary.org/events', city: 'Reading', state: 'PA', zipCode: '19605', county: 'Berks', urlCollision: 'readinglibrary.org is VT, not PA' },
  ...
  { name: 'Richland Community Library', url: 'https://www.richlandlibrary.org/', eventsUrl: 'https://www.richlandlibrary.org/Calendar', city: 'Richland', state: 'PA', zipCode: '17087', county: 'Lebanon', urlCollision: 'richlandlibrary.org is MI, not PA' },
  ...
  { name: 'Ridley Park Public Library', url: 'https://www.ridleyparklibrary.org', eventsUrl: 'https://www.ridleyparklibrary.org/events', city: 'Ridley Park', state: 'PA', zipCode: '19078', county: 'Delaware', urlCollision: "NOT RELOCATED, checked 2026-09-07. This library publishes on delcolibraries.libcal.com, but that tenant IGNORES its own per-library filter: a real id, a bogus id (999999) and no id at all return an IDENTICAL event set drawn from the whole 254-library Delaware County Library System (its unfiltered first event is \"Aston Public Library closed for Labor Day\", a different member). Relocating would therefore import the entire system under this library's name, which is worse than the zero it replaces - so no entry was created. OPEN COVERAGE GAP until a per-library URL exists" },
  ...
  { name: 'Rochester Public Library', url: 'https://www.rochesterlibrary.org/', eventsUrl: 'https://www.rochesterlibrary.org/', city: 'Rochester', state: 'PA', zipCode: '15074', county: 'Beaver', urlCollision: 'rochesterlibrary.org is IL, not PA' },
  ...
  { name: 'Paul Smith Library Of Southern York County', url: 'https://www.shrewsburylibrary.org', eventsUrl: 'https://www.shrewsburylibrary.org/events', city: 'Shrewsbury', state: 'PA', zipCode: '17361', county: 'York', urlCollision: 'shrewsburylibrary.org is VT, not PA' },
  ...
  { name: 'Spring City Free Public Library', url: 'https://springcitylibrary.org/', eventsUrl: 'https://springcitylibrary.org/', city: 'Spring City', state: 'PA', zipCode: '19475', county: 'Chester', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant ccls.libcal.com, now configured in LibCal-* as ?cid=13417 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 145 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Carnegie Library Of Mckeesport - White Oak', url: 'https://www.whiteoaklibrary.org', eventsUrl: 'https://www.whiteoaklibrary.org/events', city: 'White Oak', state: 'PA', zipCode: '15131', county: 'Allegheny', urlCollision: 'whiteoaklibrary.org is the White Oak Library District in ILLINOIS, not White Oak PA - live page shows ZIPs 60403, 60441 and 60446 with area code 815, and links whiteoak.librarycalendar.com. OPEN COVERAGE GAP: the correct URL for a White Oak PA branch is unknown'},
  ...
  // 2026-08-27: PLATFORM MISMATCH. The Step 3d hint said bibliocommons, but that was the CATALOG host (acl.bibliocommons.com, the Allegheny County Library Association catalog). Events are on wilkinsburg.librarycalendar.com, titled "Upcoming Events | Wilkinsburg Public Library". 605 Ross Avenue, Wilkinsburg PA 15221 matches this zipCode.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Wilkinsburg Public Library', url: 'https://wilkinsburglibrary.org/', eventsUrl: 'https://wilkinsburglibrary.org/', city: 'Wilkinsburg', state: 'PA', zipCode: '15221', county: 'Allegheny', urlCollision: 'platform mismatch - events are on wilkinsburg.librarycalendar.com; relocated to LibraryCalendar-Libraries 2026-08-27' },
  ...
  { name: 'Jefferson Resource Center And Computer Lab', url: 'https://yorklibrary.org/', eventsUrl: 'https://yorklibrary.org/', city: 'York', state: 'PA', zipCode: '17404', county: 'York County', urlCollision: 'yorklibrary.org is NE, not PA' },
