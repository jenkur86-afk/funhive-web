...
const LIBRARIES = [
  {
    ...
    eventsUrl: 'https://browncounty.librarycalendar.com/events/upcoming',
    city: 'Green Bay',
    state: 'WI',
    zipCode: '54301'
  },
  {
    ...
    eventsUrl: 'https://waukesha.librarycalendar.com/events/upcoming',
    city: 'Waukesha',
    state: 'WI',
    zipCode: '53186'
  },
  {
    ...
    eventsUrl: 'https://www.oshkoshlibrary.org/events/upcoming',
    city: 'Oshkosh',
    state: 'WI',
    zipCode: '54901'
  },
  {
    name: 'L.E. Phillips Memorial Library',
    eventsUrl: 'https://lephillips.librarycalendar.com/events/upcoming',
    city: 'Eau Claire',
    state: 'WI',
    zipCode: '54701'
  },
  {
    name: 'Hedberg Public Library',
    eventsUrl: 'https://www.hedbergpubliclibrary.org/events/upcoming',
    city: 'Janesville',
    state: 'WI',
    zipCode: '53545'
  },
  {
    ...
    eventsUrl: 'https://www.lacrosselibrary.org/events/upcoming',
    city: 'La Crosse',
    state: 'WI',
    zipCode: '54601'
  },
  {
    ...
    eventsUrl: 'https://www.meadpl.org/events/upcoming',
    city: 'Sheboygan',
    state: 'WI',
    zipCode: '53081'
  }
...
const SCRAPER_NAME = 'librarymarket-WI';
...
async function main() {
  console.log(`\n╔════════════════════════════════════════════════════════╗`);
  console.log(`║  Generic Scraper - WI (${LIBRARIES.length} libraries)  ║`);
  console.log(`╚════════════════════════════════════════════════════════╝\n`);
  ...
  await logScraperResult('Librarymarket Libraries WI', {
 ...
 */
async function scrapeLibraryMarketWICloudFunction() {
  console.log('☁️ Running librarymarket-WI as Cloud Function');
  const events = await scrapeGenericEvents();
  if (events.length > 0) {
    await saveToDatabase(events);
  }
...
module.exports = { scrapeGenericEvents, saveToDatabase, scrapeLibraryMarketWICloudFunction };
