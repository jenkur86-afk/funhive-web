...
const LIBRARIES = [
  ...
  { name: 'William Estes Powell Memorial Library', url: 'https://www.beaumontlibrary.org', eventsUrl: 'https://www.beaumontlibrary.org/events', city: 'Beaumont', state: 'MS', zipCode: '00000', county: 'Perry', urlCollision: "dead/hijacked domain, confirmed: dead-domain: the configured URL redirects to beaumonttexas.gov, which serves TX, not MS — a same-named town in another state, the classic guessed-{city}library.org failure; needs a correct URL or a guard Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Enterprise Public Library', url: 'https://www.enterpriselibrary.org', eventsUrl: 'https://www.enterpriselibrary.org/events', city: 'Enterprise', state: 'MS', zipCode: '00000', county: 'Clarke', urlCollision: "enterpriselibrary.org is AL, not MS - live page is Enterprise ALABAMA. Proven 2026-09-06" },
  ...
  { name: 'Houston Carnegie Library', url: 'https://www.houstonlibrary.org', eventsUrl: 'https://www.houstonlibrary.org/events', city: 'Houston', state: 'MS', zipCode: '00000', county: 'Chickasaw', urlCollision: "urlCollision confirmed 2026-09-08: houstonlibrary.org is HOUSTON PUBLIC LIBRARY, TEXAS - its pages print TX 77002 and phone 832-393-1313 (832 is Houston TX), and its calendar titles itself \"Houston Public Library\". Houston Carnegie Library is in Houston, MISSISSIPPI. Two Houstons and this host serves the far larger wrong one. Surfaced while following the site navigation for a calendar, which is why a promising CALENDAR-FOUND result was state-checked before use rather than trusted. OPEN COVERAGE GAP" },
  ...
  { name: 'Magnolia Public Library', url: 'https://www.magnolialibrary.org', eventsUrl: 'https://www.magnolialibrary.org/events', city: 'Magnolia', state: 'MS', zipCode: '00000', county: 'Pike', urlCollision: "magnolialibrary.org is MA, not MS - live page addresses print MA. Proven 2026-09-06" },
  { name: 'William And Dolores Mauldin Library', url: 'https://www.mchenrylibrary.org/', eventsUrl: 'https://www.mchenrylibrary.org/', city: 'Mchenry', state: 'MS', zipCode: '00000', county: 'Stone', urlCollision: "mchenrylibrary.org is IL, not MS - live page is McHenry Public Library District, Illinois. Two McHenrys; this host serves the wrong one. Proven 2026-09-06" },
  ...
  { name: 'Lafayette County-Oxford Public Library', url: 'https://www.first.lib.ms.us', eventsUrl: 'https://www.first.lib.ms.us', city: 'Oxford', state: 'MS', zipCode: '00000', county: 'Lafayette', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
