...
const LIBRARIES = [
  {
    ...
    eventsUrl: 'https://peoria.librarycalendar.com/events/upcoming',
    city: 'Peoria',
    state: 'IL',
    zipCode: '61602'
  },
  {
    ...
    eventsUrl: 'https://www.lincolnlibrary.info/events/upcoming',
    city: 'Springfield',
    state: 'IL',
    zipCode: '62701'
  },
  {
    ...
    eventsUrl: 'https://napervillepl.librarycalendar.com/',
    city: 'Naperville',
    state: 'IL',
    zipCode: '60540'
  },
  {
    ...
    eventsUrl: 'https://www.normalpl.org/events/upcoming',
    city: 'Normal',
    state: 'IL',
    zipCode: '61761'
  },
  {
    ...
    eventsUrl: 'https://decatur.librarycalendar.com/events/upcoming',
    city: 'Decatur',
    state: 'IL',
    zipCode: '62523'
  },
  {
    name: 'Palatine Public Library District',
    eventsUrl: 'https://www.palatinelibrary.org/events/upcoming',
    city: 'Palatine',
    state: 'IL',
    zipCode: '60067'
  },
  {
    ...
    eventsUrl: 'https://oakpark.librarycalendar.com/events/upcoming',
    city: 'Oak Park',
    state: 'IL',
    zipCode: '60302'
  },
  {
    ...
    eventsUrl: 'https://rockislandlibrary.librarymarket.com/events/week',
    city: 'Rock Island',
    state: 'IL',
    zipCode: '61201'
  }
...
const SCRAPER_NAME = 'librarymarket-IL';
...
async function main() {
  console.log(`\n╔════════════════════════════════════════════════════════╗`);
  console.log(`║  Generic Scraper - IL (${LIBRARIES.length} libraries)  ║`);
  console.log(`╚════════════════════════════════════════════════════════╝\n`);
  ...
  await logScraperResult('Librarymarket Libraries IL', {
 ...
 */
async function scrapeLibraryMarketILCloudFunction() {
  console.log('☁️ Running librarymarket-IL as Cloud Function');
  const events = await scrapeGenericEvents();
  if (events.length > 0) {
    await saveToDatabase(events);
  }
...
module.exports = { scrapeGenericEvents, saveToDatabase, scrapeLibraryMarketILCloudFunction };
