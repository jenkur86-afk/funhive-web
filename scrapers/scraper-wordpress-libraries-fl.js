...
const LIBRARIES = [
  ...
  { name: 'Edgewater Public Library', url: 'https://www.edgewaterlibrary.org', eventsUrl: 'https://www.edgewaterlibrary.org/events', city: 'Edgewater', state: 'FL', zipCode: '00000', county: 'Volusia', urlCollision: 'edgewaterlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Freeport Branch Library', url: 'https://www.freeportlibrary.org', eventsUrl: 'https://www.freeportlibrary.org/events', city: 'Freeport', state: 'FL', zipCode: '00000', county: 'Walton', urlCollision: 'freeportlibrary.org is PA, not FL' },
  { name: 'Fruitland Park Library', url: 'https://www.fruitlandparklibrary.org', eventsUrl: 'https://www.fruitlandparklibrary.org/events', city: 'Fruitland Park', state: 'FL', zipCode: '00000', county: 'Lake', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  { name: 'Greenville Public Library', url: 'https://www.greenvillelibrary.org', eventsUrl: 'https://www.greenvillelibrary.org/events', city: 'Greenville', state: 'FL', zipCode: '00000', county: 'Madison', urlCollision: 'greenvillelibrary.org is SC, not FL' },
  ...
  { name: 'Margate Catharine Young Branch', url: 'https://www.margatelibrary.org', eventsUrl: 'https://www.margatelibrary.org/events', city: 'Margate', state: 'FL', zipCode: '00000', county: 'Broward', urlCollision: 'margatelibrary.org is NJ, not FL' },
  ...
  // 2026-08-26: newberrylibrary.org is DEAD - resolves to 74.254.67.33, refuses both 443 and 80 - and was shared with SC. The real institution is the Alachua County Library District Newberry Branch, 110 S Seaboard Dr, Newberry FL, at aclib.us/newberry-branch. NOT repointed: ACLD runs Communico at attend.aclib.us/events, already configured under Communico-FL, and a WordPress DOM extractor aimed at a Communico calendar is a platform mismatch rather than a URL typo. COVERAGE IS EXPLICITLY NOT CLAIMED: Communico-FL currently returns ZERO rows, so this stays an OPEN GAP.
  { name: 'Newberry Branch Library', url: 'https://www.newberrylibrary.org', eventsUrl: 'https://www.newberrylibrary.org/events', city: 'Newberry', state: 'FL', zipCode: '00000', county: 'Alachua', urlCollision: 'newberrylibrary.org is dead and was shared with SC; real site is aclib.us which runs Communico - see Communico-FL, which currently returns 0 rows' },
  ...
  { name: 'East Lake Community Library', url: 'https://www.palmharborlibrary.org', eventsUrl: 'https://www.palmharborlibrary.org/events', city: 'Palm Harbor', state: 'FL', zipCode: '00000', county: 'Pinellas', urlCollision: 'urlCollision confirmed 2026-09-07: this entry points at palmharborlibrary.org, which is PALM HARBOR LIBRARY - a different institution in the same town, not East Lake Community Library. Palm Harbor Library was added to LibraryCalendar-Libraries in its own right on the same day, since nothing else covered it and this entry could only ever return 0 for either library. East Lake itself has no working URL here. OPEN COVERAGE GAP'},
  ...
  { name: 'Taylor County Public Library', url: 'https://www.perrylibrary.org/', eventsUrl: 'https://www.perrylibrary.org/calendar', city: 'Perry', state: 'FL', zipCode: '32347', county: 'Taylor', urlCollision: 'perrylibrary.org is NC, not FL' },
  { name: 'Pierson Public Library', url: 'https://www.piersonlibrary.org', eventsUrl: 'https://www.piersonlibrary.org/events', city: 'Pierson', state: 'FL', zipCode: '00000', county: 'Volusia', urlCollision: 'piersonlibrary.org is VT, not FL' },
  ...
  { name: 'Reddick Public Library', url: 'https://www.reddicklibrary.org/', eventsUrl: 'https://www.reddicklibrary.org/', city: 'Reddick', state: 'FL', zipCode: '00000', county: 'Marion', urlCollision: "urlCollision confirmed 2026-09-07: reddicklibrary.org is Reddick Public Library District in Ottawa, ILLINOIS - the live page prints IL 61350 and phones 815-434-0509 / 815-434-2634, and its libnet calendar titles itself \"Reddick Public Library District\". Reddick FLORIDA in Marion County has no working URL here. Caught on the state check AFTER the title check passed, which is exactly why a matching title is not sufficient evidence. OPEN COVERAGE GAP, not a relocation" },
  ...
  { name: 'Vernon Branch Library', url: 'https://www.vernonlibrary.org/', eventsUrl: 'https://www.vernonlibrary.org/', city: 'Vernon', state: 'FL', zipCode: '00000', county: 'Washington', urlCollision: 'vernonlibrary.org is TX, not FL' },
  { name: 'E.C. Rowell Public Library', url: 'https://www.websterlibrary.org', eventsUrl: 'https://www.websterlibrary.org/events', city: 'Webster', state: 'FL', zipCode: '00000', county: 'Sumter', urlCollision: 'websterlibrary.org is NY, not FL' },
  ...
  { name: 'Wildwood Public Library', url: 'https://www.wildwoodlibrary.org', eventsUrl: 'https://www.wildwoodlibrary.org/events', city: 'Wildwood', state: 'FL', zipCode: '00000', county: 'Sumter', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
...
const SCRAPER_NAME = 'WordPress-FL';
