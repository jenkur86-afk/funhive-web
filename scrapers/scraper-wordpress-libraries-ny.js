...
const LIBRARIES = [
  ...
  { name: 'Baldwin Public Library', url: 'https://www.baldwinpl.org', eventsUrl: 'https://baldwinlib.libcal.com/calendar', city: 'Baldwin', state: 'NY', zipCode: '11510', county: 'Nassau', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance baldwinpl.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 114 items titled for this same library'},
  ...
  { name: 'Schenectady County Public Library', url: 'https://www.scpl.org', eventsUrl: 'https://www.scpl.org/events', city: 'Schenectady', state: 'NY', zipCode: '12305', county: 'Schenectady County', urlCollision: 'publishes on schenectady.librarycalendar.com - link taken from the library own page, NY confirmed by ZIP 12305 and area code 518. Relocated to LibraryCalendar-Libraries on 2026-08-27'},
  ...
  { name: 'New Rochelle Public Library', url: 'https://nrpl.org/', eventsUrl: 'https://nrpl.org/', city: 'New Rochelle', state: 'NY', zipCode: '10801', county: 'Westchester', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on newrochelle.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself New Rochelle Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Alfred Box Of Books Library', url: 'https://www.alfredlibrary.org', eventsUrl: 'https://www.alfredlibrary.org/events', city: 'Alfred', state: 'NY', zipCode: '14802', county: 'Allegany', urlCollision: 'alfredlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Andover Free Library', url: 'https://www.andoverlibrary.org', eventsUrl: 'https://www.andoverlibrary.org/events', city: 'Andover', state: 'NY', zipCode: '14806', county: 'Allegany', urlCollision: 'andoverlibrary.org is KS, not NY' },
  ...
  { name: 'Brentwood Public Library', url: 'https://www.brentwoodlibrary.org', eventsUrl: 'https://www.brentwoodlibrary.org/events', city: 'Brentwood', state: 'NY', zipCode: '11717', county: 'Suffolk', urlCollision: 'brentwoodlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  // 2026-08-27: PLATFORM MISMATCH plus a collision. This entry pointed at a LibCal URL from the WordPress family, and the same URL was claimed by Brewster Ladies Library MA. The host is NEW YORK: brewsterlibrary.org is Brewster Public Library, 79 Main St, Brewster NY. Relocated to the LibCal config.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Brewster Public Library', url: 'https://brewsterlibrary.libcal.com/', eventsUrl: 'https://brewsterlibrary.libcal.com/', city: 'Brewster', state: 'NY', zipCode: '10509', county: 'Putnam', urlCollision: 'platform mismatch - runs LibCal; relocated to the LibCal family 2026-08-27 (host was also claimed by Brewster MA)' },
  ...
  { name: 'Central Islip Public Library', url: 'https://www.centralisliplibrary.org', eventsUrl: 'https://www.centralisliplibrary.org/events', city: 'Central Islip', state: 'NY', zipCode: '11722', county: 'Suffolk', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'Cutchogue New Suffolk Free Library', url: 'https://cutchoguelibrary.org/', eventsUrl: 'https://cutchoguelibrary.org/', city: 'Cutchogue', state: 'NY', zipCode: '11935', county: 'Suffolk', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on cutchogue.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Cutchogue New Suffolk Free Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  { name: 'Dansville Public Library', url: 'https://dansvillelibrary.org/', eventsUrl: 'https://dansvillelibrary.org/calendar/', city: 'Dansville', state: 'NY', zipCode: '14437', county: 'Livingston', urlCollision: 'publishes on owwl.libcal.com/calendar/DansvillePublicLibrary cid 15151 - link taken from the library own page, NY confirmed by 200 Main St Dansville NY 14437 and area code 585. Relocated to LibCal-NY on 2026-08-27'},
  ...
  // 2026-08-27: PLATFORM MISMATCH. Its own site links to midyork.libnet.info, the Mid-York Library System consortium calendar, titled "Events - Mid York Library System" and printing NY 13502. Added to Communico ONCE as the consortium, not three times.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Dolgeville-Manheim Public Library', url: 'https://dolgevillelibrary.org/', eventsUrl: 'https://dolgevillelibrary.org/', city: 'Dolgeville', state: 'NY', zipCode: '13329', county: 'Herkimer', urlCollision: 'platform mismatch - publishes on the Mid-York consortium at midyork.libnet.info; relocated to Communico 2026-08-27' },
  ...
  { name: 'Queens Borough Public Library - Elmhurst', url: 'https://www.elmhurstlibrary.org', eventsUrl: 'https://www.elmhurstlibrary.org/events', city: 'Elmhurst', state: 'NY', zipCode: '11373', county: 'Queens', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'Franklin Free Library', url: 'https://www.franklinlibrary.org', eventsUrl: 'https://www.franklinlibrary.org/events', city: 'Franklin', state: 'NY', zipCode: '13775', county: 'Franklin County', urlCollision: 'franklinlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Gardiner Library', url: 'https://www.gardinerlibrary.org/', eventsUrl: 'https://www.gardinerlibrary.org/', city: 'Gardiner', state: 'NY', zipCode: '12525', county: 'Ulster', urlCollision: 'publishes on gardinerlibrary.libcal.com cid 21138 - link taken from the library own page, NY confirmed by 133 Farmers Turnpike Gardiner NY 12525 and area code 845. Relocated to LibCal-NY on 2026-08-27'},
  ...
  { name: 'Glen Cove Public Library', url: 'https://www.glencovelibrary.org/', eventsUrl: 'https://www.glencovelibrary.org/', city: 'Glen Cove', state: 'NY', zipCode: '11542', county: 'Nassau', urlCollision: "RELOCATED 2026-09-07: this library publishes on LibCal at glencovelibrary.libcal.com (LibCal-NY), and is now configured there. A WordPress DOM scraper structurally cannot read that platform, so this entry could only ever return 0. NOT a coverage gap - coverage moved, it did not disappear. Identity was taken from the destination page's own title, not from name similarity" },
  ...
  { name: 'Goshen Public Library And Historical Society', url: 'https://www.goshenlibrary.org/', eventsUrl: 'https://www.goshenlibrary.org/', city: 'Goshen', state: 'NY', zipCode: '10924', county: 'Orange', urlCollision: 'goshenlibrary.org is NH, not NY' },
  ...
  { name: 'Hammond Free Library', url: 'https://www.hammondlibrary.org', eventsUrl: 'https://www.hammondlibrary.org/events', city: 'Hammond', state: 'NY', zipCode: '13646', county: 'St. Lawrence', urlCollision: 'urlCollision confirmed 2026-09-07: hammondlibrary.org is the same guessed {city}library.org shape as the rest of Defect A, and the LibraryCalendar instance behind it, hammondpl.librarycalendar.com, titles itself Hammond Public Library on (219) 931-5100 - area code 219 is INDIANA. Hammond NY 13646 in St. Lawrence County has no working URL here. OPEN COVERAGE GAP, not a fixed entry'},
  ...
  // 2026-08-27: PLATFORM MISMATCH. hauppaugelibrary.libnet.info titles itself "Events - Hauppauge Public Library" and prints NY 11788, matching this zipCode exactly.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Hauppauge Public Library', url: 'https://www.hauppaugelibrary.org', eventsUrl: 'https://www.hauppaugelibrary.org/events', city: 'Hauppauge', state: 'NY', zipCode: '11788', county: 'Suffolk', urlCollision: 'platform mismatch - publishes on hauppaugelibrary.libnet.info; relocated to Communico 2026-08-27' },
  { name: 'Haverstraw Kings Daughters Public Library - Village Branch', url: 'https://www.haverstrawlibrary.org', eventsUrl: 'https://www.haverstrawlibrary.org/events', city: 'Haverstraw', state: 'NY', zipCode: '10927', county: 'Rockland', urlCollision: 'publishes on haverstraw.librarycalendar.com - link taken from the library own page, NY confirmed by ZIPs 10923 and 10927 with area code 845. Relocated to LibraryCalendar-Libraries at system level on 2026-08-27'},
  { name: 'Highland Public Library', url: 'https://highlandlibrary.org/', eventsUrl: 'https://highlandlibrary.org/', city: 'Highland', state: 'NY', zipCode: '12528', county: 'Ulster', urlCollision: 'publishes on highlandlibrary.libcal.com cid 12635 - link taken from the library own page, NY confirmed by 14 Elting Place Highland NY 12528 and area code 845. Relocated to LibCal-NY on 2026-08-27'},
  ...
  // 2026-08-27: PLATFORM MISMATCH - same Mid-York consortium instance as Dolgeville-Manheim and New Woodstock.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'Holland Patent Free Library', url: 'https://hollandpatentlibrary.org/', eventsUrl: 'https://hollandpatentlibrary.org/', city: 'Holland Patent', state: 'NY', zipCode: '13354', county: 'Oneida', urlCollision: 'platform mismatch - publishes on the Mid-York consortium at midyork.libnet.info; relocated to Communico 2026-08-27' },
  ...
  { name: 'Phillips Free Library', url: 'https://phillipsfreelibrary.org', eventsUrl: 'https://phillipsfreelibrary.org/events/', city: 'Homer', state: 'NY', zipCode: '13077', county: 'Cortland', urlCollision: 'events are in a cross-origin Google Calendar iframe, unreadable by a DOM extractor. Relocated to GoogleCalendar-NY 2026-09-06, proven live at 53 rows. Identity confirmed from the live page as Homer Phillips Free Library, 37 South Main St, Homer NY 13077, ph 607-749-4616'},
  ...
  { name: 'Huntington Public Library', url: 'https://www.huntingtonlibrary.org', eventsUrl: 'https://www.huntingtonlibrary.org/events', city: 'Huntington', state: 'NY', zipCode: '11743', county: 'Suffolk', urlCollision: 'huntingtonlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Locust Valley Library', url: 'https://www.locustvalleylibrary.org', eventsUrl: 'https://www.locustvalleylibrary.org/events', city: 'Locust Valley', state: 'NY', zipCode: '11560', county: 'Nassau', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance locustvalleylibrary.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 81 items titled for this same library'},
  ...
  { name: 'Marcellus Free Library', url: 'https://www.marcelluslibrary.org', eventsUrl: 'https://www.marcelluslibrary.org/events', city: 'Marcellus', state: 'NY', zipCode: '13108', county: 'Onondaga', urlCollision: 'publishes on onlib-marcellus.libcal.com cid 19783 - link taken from the library own page, NY confirmed by 32 Maple Street Marcellus NY 13108 and area code 315. Relocated to LibCal-NY on 2026-08-27'},
  ...
  { name: 'Menands Public Library', url: 'https://www.menandslibrary.org', eventsUrl: 'https://www.menandslibrary.org/events', city: 'Menands', state: 'NY', zipCode: '12204', county: 'Albany', urlCollision: "RELOCATED 2026-09-08: publishes on the Upper Hudson SYSTEM host uhls.librarycalendar.com, now configured in LibraryCalendar-Libraries as ?branches[83]=83 so only Menands is read - the bare system URL would import all 19 member libraries under this name. Verified: 841 event cards with Menands as the venue, 805 unfiltered showing other branches, bogus branch id returns empty. A WordPress DOM scraper cannot read LibraryCalendar. NOT a coverage gap" },
  ...
  { name: 'Ramapo Catskill Library System', url: 'https://www.middletownlibrary.org', eventsUrl: 'https://www.middletownlibrary.org/events', city: 'Middletown', state: 'NY', zipCode: '10940', county: 'Orange', urlCollision: 'middletownlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Minoa Library', url: 'https://www.minoalibrary.org', eventsUrl: 'https://www.minoalibrary.org/events', city: 'Minoa', state: 'NY', zipCode: '13116', county: 'Onondaga', urlCollision: "RELOCATED 2026-09-07: this library publishes on LibCal at onlib-minoa.libcal.com (LibCal-NY), and is now configured there. A WordPress DOM scraper structurally cannot read that platform, so this entry could only ever return 0. NOT a coverage gap - coverage moved, it did not disappear. Identity was taken from the destination page's own title, not from name similarity" },
  ...
  { name: 'Naples Library', url: 'https://www.napleslibrary.org', eventsUrl: 'https://www.napleslibrary.org/events', city: 'Naples', state: 'NY', zipCode: '14512', county: 'Ontario', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant owwl.libcal.com, now configured in LibCal-* as ?cid=12970 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 162 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  // 2026-08-27: PLATFORM MISMATCH - same Mid-York consortium instance as Dolgeville-Manheim and Holland Patent.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'New Woodstock Free Library', url: 'https://newwoodstocklibrary.org/', eventsUrl: 'https://newwoodstocklibrary.org/', city: 'New Woodstock', state: 'NY', zipCode: '13122', county: 'Madison', urlCollision: 'platform mismatch - publishes on the Mid-York consortium at midyork.libnet.info; relocated to Communico 2026-08-27' },
  ...
  { name: 'Pike Library', url: 'https://www.pikelibrary.org', eventsUrl: 'https://www.pikelibrary.org/events', city: 'Pike', state: 'NY', zipCode: '14130', county: 'Wyoming', urlCollision: 'pikelibrary.org is KY, not NY' },
  ...
  { name: 'Quogue Library', url: 'https://www.quoguelibrary.org/', eventsUrl: 'https://www.quoguelibrary.org/', city: 'Quogue', state: 'NY', zipCode: '11959', county: 'Suffolk', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on quogue.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Quogue Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  { name: 'Rensselaerville Public Library', url: 'https://www.rensselaervillelibrary.org', eventsUrl: 'https://www.rensselaervillelibrary.org/events', city: 'Rensselaerville', state: 'NY', zipCode: '12147', county: 'Albany', urlCollision: 'publishes on uhls.librarycalendar.com with its own branch filter branches[77]=88 - link taken from the library own page, NY confirmed by ZIP 12147 and area code 518. Relocated to LibraryCalendar-Libraries on 2026-08-27'},
  ...
  { name: 'Rodman Public Library', url: 'https://www.rodmanlibrary.org', eventsUrl: 'https://www.rodmanlibrary.org/events', city: 'Rodman', state: 'NY', zipCode: '13682', county: 'Jefferson', urlCollision: 'rodmanlibrary.org redirects to rodmanlibrary.com which is Rodman Public Library in ALLIANCE OHIO - 215 East Broadway Street, Alliance OH 44601, area code 330. Not New York. The verifier reported platform=libcal for it and wiring that instance into LibCal-NY would have imported Ohio events under NY. OPEN COVERAGE GAP: the correct URL for any NY Rodman library is unknown'},
  { name: 'The Jervis Public Library Association, Inc.', url: 'https://www.romelibrary.org', eventsUrl: 'https://www.romelibrary.org/events', city: 'Rome', state: 'NY', zipCode: '13440', county: 'Oneida', urlCollision: "dead/hijacked domain, confirmed: dead-endpoint: HTTP 404 on the configured URL [redirects to fightbackvenice.org] Guarded 2026-09-07 so the rotation stops visiting it — a squatted domain is one selector change away from importing another site's markup as events. NOT deleted: this stays an explained OPEN COVERAGE GAP until a real URL is found." },
  ...
  { name: 'Seaford Public Library', url: 'https://seafordlibrary.org/', eventsUrl: 'https://seafordlibrary.org/library-events/', city: 'Seaford', state: 'NY', zipCode: '11783', county: 'Nassau', urlCollision: 'events are on Assabet, unreadable by a WordPress DOM extractor - the site names instance seafordlibrary.assabetinteractive.com. Relocated to Assabet-NH-MA on 2026-09-06 after its upcoming-events.rss returned 33 items titled for this same library'},
  ...
  { name: 'Shelter Island Public Library Society', url: 'https://www.shelterislandlibrary.org', eventsUrl: 'https://www.shelterislandlibrary.org/events', city: 'Shelter Island', state: 'NY', zipCode: '11964', county: 'Suffolk', urlCollision: "host is DEAD, probed 2026-09-07: the origin answered nothing on any of 8 paths (/, /events, /events/, /calendar, /calendar/, /events/upcoming, /whats-on, /programs). This is a host failure, not a wrong path - the distinction was checked rather than assumed, because a bare 404 on one path is not evidence a site is gone. Guarded so the rotation stops visiting it. OPEN COVERAGE GAP until a real URL is found" },
  ...
  { name: 'Sidney Memorial Public Library', url: 'https://www.sidneylibrary.org/', eventsUrl: 'https://www.sidneylibrary.org/index.php/calendar/', city: 'Sidney', state: 'NY', zipCode: '13838', county: 'Delaware', urlCollision: 'events are in a cross-origin Google Calendar iframe, unreadable by a DOM extractor. Relocated to GoogleCalendar-NY 2026-09-06, proven live at 92 rows. NOTE sidneylibrary.org is a THREE-WAY host collision claimed by NY, IL and OH, and the live page settles it for NEW YORK: Sidney Memorial Public Library, 8 River Street, Sidney NY 13838, ph 607-563-1200. The IL and OH claimants are wrong but sit in inactive regions and never run'},
  ...
  { name: 'Smyrna Public Library', url: 'https://www.smyrnalibrary.org', eventsUrl: 'https://www.smyrnalibrary.org/events', city: 'Smyrna', state: 'NY', zipCode: '13464', county: 'Chenango', urlCollision: 'smyrnalibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  { name: 'Stone Ridge Public Library', url: 'https://stoneridgelibrary.org/', eventsUrl: 'https://stoneridgelibrary.org/', city: 'Stone Ridge', state: 'NY', zipCode: '12484', county: 'Ulster', urlCollision: "RELOCATED 2026-09-07: this library publishes on LibCal at stoneridgelibrary.libcal.com (LibCal-NY), and is now configured there. A WordPress DOM scraper structurally cannot read that platform, so this entry could only ever return 0. NOT a coverage gap - coverage moved, it did not disappear. Identity was taken from the destination page's own title, not from name similarity" },
  ...
  { name: 'Syosset Public Library', url: 'https://www.syossetlibrary.org', eventsUrl: 'https://www.syossetlibrary.org/events', city: 'Syosset', state: 'NY', zipCode: '11791', county: 'Nassau', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 - this library publishes on syosset.librarycalendar.com, a LibraryCalendar instance that a WordPress DOM extractor cannot read. Host was discovered in this library own page markup and then confirmed live: the page titles itself Syosset Public Library and its programme renders server-side. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  { name: 'Tappan Library', url: 'https://tappanlibrary.org/', eventsUrl: 'https://tappanlibrary.org/', city: 'Tappan', state: 'NY', zipCode: '10983', county: 'Rockland', urlCollision: 'relocated to LibraryCalendar-Libraries 2026-09-07 under the SYSTEM name South Orangetown Libraries, which is what southorangetownlibraries.librarycalendar.com titles itself. Tappan and Orangeburg are its two branches, both Rockland County NY, so the span is bounded and stays in state. The WordPress entry is guarded rather than deleted so the library keeps its audit row'},
  ...
  // 2026-08-27: PLATFORM MISMATCH. westisliplibrary.libnet.info titles itself "Events - West Islip Public Library" and prints NY 11795, matching this zipCode exactly.
  // Guarded rather than deleted so the library keeps an explained row in LIBRARY-SITE-AUDIT.md.
  { name: 'West Islip Public Library', url: 'https://westisliplibrary.org/', eventsUrl: 'https://westisliplibrary.org/', city: 'West Islip', state: 'NY', zipCode: '11795', county: 'Suffolk', urlCollision: 'platform mismatch - publishes on westisliplibrary.libnet.info; relocated to Communico 2026-08-27' },
  { name: 'West Nyack Free Library', url: 'https://www.westnyacklibrary.org/', eventsUrl: 'https://www.westnyacklibrary.org/', city: 'West Nyack', state: 'NY', zipCode: '10994', county: 'Rockland', urlCollision: "RELOCATED 2026-09-07: this library publishes on LibCal at westnyacklib.libcal.com (LibCal-NY), and is now configured there. A WordPress DOM scraper structurally cannot read that platform, so this entry could only ever return 0. NOT a coverage gap - coverage moved, it did not disappear. Identity was taken from the destination page's own title, not from name similarity" },
  ...
  { name: 'Williamson Free Public Library', url: 'https://www.williamsonlibrary.org/', eventsUrl: 'https://www.williamsonlibrary.org/', city: 'Williamson', state: 'NY', zipCode: '14589', county: 'Wayne', urlCollision: "RELOCATED 2026-09-07: publishes on the shared LibCal tenant owwl.libcal.com, now configured in LibCal-* as ?cid=12971 so ONLY this library's calendar is read - the bare consortium host would import every member library under this name. Verified live: 131 event elements returned for that cid. A WordPress DOM scraper cannot read LibCal at all, so this entry could only ever return 0. NOT a coverage gap" },
  ...
  { name: 'Wyandanch Public Library', url: 'https://www.wyandanchlibrary.org', eventsUrl: 'https://www.wyandanchlibrary.org/events', city: 'Wyandanch', state: 'NY', zipCode: '11798', county: 'Suffolk', urlCollision: 'publishes on wyandanch.librarycalendar.com - link taken from the library own page, NY confirmed by ZIP 11798 and area code 631. Relocated to LibraryCalendar-Libraries on 2026-08-27'},
