...
const LIBRARIES = [
  ...
  { name: 'Adams Free Library', url: 'https://www.adamslibrary.org', eventsUrl: 'https://www.adamslibrary.org/events', city: 'Adams', state: 'NY', zipCode: '13605', county: 'Jefferson'},
  ...
  { name: 'Avon Free Library', url: 'https://www.avonlibrary.org', eventsUrl: 'https://www.avonlibrary.org/events', city: 'Avon', state: 'NY', zipCode: '14414', county: 'Livingston'},
  ...
  { name: 'Dormann Library', url: 'https://www.bathlibrary.org', eventsUrl: 'https://www.bathlibrary.org/events', city: 'Bath', state: 'NY', zipCode: '14810', county: 'Steuben'},
  ...
  { name: 'Belleville Free Library', url: 'https://bellevillelibrary.org/', eventsUrl: 'https://bellevillelibrary.org/', city: 'Belleville', state: 'NY', zipCode: '13611', county: 'Jefferson'},
  ...
  { name: 'Berlin Free Town Library', url: 'https://www.berlinlibrary.org', eventsUrl: 'https://www.berlinlibrary.org/events', city: 'Berlin', state: 'NY', zipCode: '12022', county: 'Rensselaer'},
  ...
  { name: 'Boston Free Library', url: 'https://www.bostonlibrary.org', eventsUrl: 'https://www.bostonlibrary.org/events', city: 'Boston', state: 'NY', zipCode: '14025', county: 'Erie'},
  ...
  { name: 'Sullivan Free Library Of Bridgeport', url: 'https://www.bridgeportlibrary.org/', eventsUrl: 'https://www.bridgeportlibrary.org/calendar', city: 'Bridgeport', state: 'NY', zipCode: '13030', county: 'Madison'},
  ...
  { name: 'Cambridge Public Library', url: 'https://www.cambridgelibrary.org', eventsUrl: 'https://www.cambridgelibrary.org/events', city: 'Cambridge', state: 'NY', zipCode: '12816', county: 'Washington'},
  ...
  { name: 'Carthage Free Library', url: 'https://www.carthagelibrary.org', eventsUrl: 'https://www.carthagelibrary.org/events', city: 'Carthage', state: 'NY', zipCode: '13619', county: 'Jefferson'},
  ...
  { name: 'Village Library Of Cooperstown', url: 'https://www.cooperstownlibrary.org', eventsUrl: 'https://www.cooperstownlibrary.org/events', city: 'Cooperstown', state: 'NY', zipCode: '13326', county: 'Otsego'},
  ...
  { name: 'Cornwall Public Library', url: 'https://www.cornwalllibrary.org', eventsUrl: 'https://www.cornwalllibrary.org/events', city: 'Cornwall', state: 'NY', zipCode: '12518', county: 'Orange'},
  ...
  { name: 'Frankfort Free Library', url: 'https://www.frankfortlibrary.org/', eventsUrl: 'https://www.frankfortlibrary.org/', city: 'Frankfort', state: 'NY', zipCode: '13340', county: 'Herkimer'},
  ...
  { name: 'Gorham Free Library', url: 'https://gorhamlibrary.org/', eventsUrl: 'https://gorhamlibrary.org/calendar/', city: 'Gorham', state: 'NY', zipCode: '14461', county: 'Ontario'},
  ...
  { name: 'Grafton Community Library', url: 'https://www.graftonlibrary.org', eventsUrl: 'https://www.graftonlibrary.org/events', city: 'Grafton', state: 'NY', zipCode: '12082', county: 'Rensselaer'},
  { name: 'Pember Library Museum', url: 'https://www.granvillelibrary.org/', eventsUrl: 'https://www.granvillelibrary.org/', city: 'Granville', state: 'NY', zipCode: '12832', county: 'Washington'},
  ...
  { name: 'Easton Library', url: 'https://www.greenwichlibrary.org/', eventsUrl: 'https://www.greenwichlibrary.org/', city: 'Greenwich', state: 'NY', zipCode: '12834', county: 'Washington'},
  ...
  { name: 'Roeliff Jansen Community Library Association', url: 'https://www.cityofsanmateo.org/', eventsUrl: 'https://www.cityofsanmateo.org/507/Library', city: 'Hillsdale', state: 'NY', zipCode: '12529', county: 'Columbia'},
  ...
  { name: 'Hudson Area Association Library', url: 'https://www.hudsonlibrary.org', eventsUrl: 'https://www.hudsonlibrary.org/events', city: 'Hudson', state: 'NY', zipCode: '12534', county: 'Columbia'},
  ...
  { name: 'Chautauqua-Cattaraugus Library System', url: 'https://www.jamestownlibrary.org', eventsUrl: 'https://www.jamestownlibrary.org/events', city: 'Jamestown', state: 'NY', zipCode: '14701', county: 'Chautauqua'},
  ...
  { name: 'Kennedy Free Library', url: 'https://www.kennedylibrary.org', eventsUrl: 'https://www.kennedylibrary.org/events', city: 'Kennedy', state: 'NY', zipCode: '14747', county: 'Chautauqua'},
  ...
  { name: 'Lancaster Public Library', url: 'https://www.lancasterlibrary.org/', eventsUrl: 'https://www.lancasterlibrary.org/component/tags/tag/events', city: 'Lancaster', state: 'NY', zipCode: '14086', county: 'Erie'},
  ...
  { name: 'Peninsula Public Library', url: 'https://lawrencelibrary.org/', eventsUrl: 'https://lawrencelibrary.org/', city: 'Lawrence', state: 'NY', zipCode: '11559', county: 'Nassau'},
  ...
  { name: 'Little Falls Public Library', url: 'https://www.littlefallslibrary.org', eventsUrl: 'https://www.littlefallslibrary.org/events', city: 'Little Falls', state: 'NY', zipCode: '13365', county: 'Herkimer'},
  ...
  { name: 'Lyons Public Library', url: 'https://lyonslibrary.org/', eventsUrl: 'https://lyonslibrary.org/', city: 'Lyons', state: 'NY', zipCode: '14489', county: 'Wayne'},
  ...
  { name: 'Marion Public Library', url: 'https://www.marionlibrary.org/', eventsUrl: 'https://www.marionlibrary.org/', city: 'Marion', state: 'NY', zipCode: '14505', county: 'Wayne'},
  ...
  { name: 'Milford Free Library', url: 'https://www.milfordlibrary.org', eventsUrl: 'https://www.milfordlibrary.org/events', city: 'Milford', state: 'NY', zipCode: '13807', county: 'Otsego'},
  ...
  { name: 'Sarah Hull Hallock Free Library', url: 'https://www.miltonlibrary.org', eventsUrl: 'https://www.miltonlibrary.org/events', city: 'Milton', state: 'NY', zipCode: '12547', county: 'Saratoga'},
  ...
  { name: 'Ethelbert B. Crawford Public Library', url: 'https://www.allertonpubliclibrary.org/', eventsUrl: 'https://www.allertonpubliclibrary.org/calendar', city: 'Monticello', state: 'NY', zipCode: '12701', county: 'Sullivan'},
  ...
  { name: 'Hendrick Hudson Free Library', url: 'https://www.montroselibrary.org', eventsUrl: 'https://www.montroselibrary.org/events', city: 'Montrose', state: 'NY', zipCode: '10548', county: 'Westchester'},
  ...
  { name: 'Morristown Public Library', url: 'https://www.morristownlibrary.org', eventsUrl: 'https://www.morristownlibrary.org/events', city: 'Morristown', state: 'NY', zipCode: '13664', county: 'St. Lawrence'},
  ...
  { name: 'Newport Free Library', url: 'https://www.newportlibrary.org', eventsUrl: 'https://www.newportlibrary.org/events', city: 'Newport', state: 'NY', zipCode: '13416', county: 'Herkimer'},
  { name: 'Hepburn Library Of Norfolk', url: 'https://www.norfolklibrary.org', eventsUrl: 'https://www.norfolklibrary.org/events', city: 'Norfolk', state: 'NY', zipCode: '13667', county: 'St. Lawrence'},
  ...
  { name: 'Perry Public Library', url: 'https://www.perrylibrary.org/', eventsUrl: 'https://www.perrylibrary.org/calendar', city: 'Perry', state: 'NY', zipCode: '14530', county: 'Wyoming'},
  { name: 'Peru Free Library', url: 'https://www.perulibrary.org', eventsUrl: 'https://www.perulibrary.org/events', city: 'Peru', state: 'NY', zipCode: '12972', county: 'Clinton'},
  { name: 'Phelps Community Memorial Library', url: 'https://www.phelpslibrary.org', eventsUrl: 'https://www.phelpslibrary.org/events', city: 'Phelps', state: 'NY', zipCode: '14532', county: 'Ontario'},
  ...
  { name: 'Randolph Free Library', url: 'https://www.randolphlibrary.org', eventsUrl: 'https://www.randolphlibrary.org/events', city: 'Randolph', state: 'NY', zipCode: '14772', county: 'Cattaraugus'},
  ...
  { name: 'Queens Borough Public Library - Ridgewood', url: 'https://ridgewoodlibrary.org/', eventsUrl: 'https://ridgewoodlibrary.org/', city: 'Ridgewood', state: 'NY', zipCode: '11385', county: 'Queens'},
  ...
  { name: 'Bancroft Public Library', url: 'https://www.salemlibrary.org', eventsUrl: 'https://www.salemlibrary.org/events', city: 'Salem', state: 'NY', zipCode: '12865', county: 'Washington'},
  ...
  { name: 'Minerva Free Library', url: 'https://www.shermanlibrary.org/', eventsUrl: 'https://www.shermanlibrary.org/', city: 'Sherman', state: 'NY', zipCode: '14781', county: 'Chautauqua'},
  { name: 'Mastics-Moriches-Shirley Community Lib', url: 'https://www.shirleylibrary.org/', eventsUrl: 'https://www.shirleylibrary.org/', city: 'Shirley', state: 'NY', zipCode: '11967', county: 'Suffolk'},
  ...
  { name: 'Rogers Memorial Library', url: 'https://www.southamptonlibrary.org', eventsUrl: 'https://www.southamptonlibrary.org/events', city: 'Southampton', state: 'NY', zipCode: '11968', county: 'Suffolk'},
  ...
  { name: 'Stamford Village Library', url: 'https://www.stamfordlibrary.org', eventsUrl: 'https://www.stamfordlibrary.org/events', city: 'Stamford', state: 'NY', zipCode: '12167', county: 'Delaware'},
  ...
  { name: 'Brunswick Community Library', url: 'https://www.troylibrary.org', eventsUrl: 'https://www.troylibrary.org/events', city: 'Troy', state: 'NY', zipCode: '12180', county: 'Rensselaer'},
  ...
  { name: 'Brookhaven National Laboratory', url: 'https://uptonlibrarystaff.wixsite.com/', eventsUrl: 'https://uptonlibrarystaff.wixsite.com/uptontownlibrary', city: 'Upton', state: 'NY', zipCode: '11973', county: 'Suffolk'},
  ...
  { name: 'Vernon Public Library', url: 'https://www.vernonlibrary.org/', eventsUrl: 'https://www.vernonlibrary.org/', city: 'Vernon', state: 'NY', zipCode: '13476', county: 'Oneida'},
  ...
  { name: 'Warsaw Public Library', url: 'https://www.warsawlibrary.org/', eventsUrl: 'https://www.warsawlibrary.org/', city: 'Warsaw', state: 'NY', zipCode: '14569', county: 'Wyoming'},
  { name: 'Albert Wisner Public Library', url: 'https://warwicklibrary.org/', eventsUrl: 'https://warwicklibrary.org/', city: 'Warwick', state: 'NY', zipCode: '10990', county: 'Orange'},
  ...
  { name: 'East Hounsfield Free Library', url: 'https://www.watertownlibrary.org/', eventsUrl: 'https://www.watertownlibrary.org/', city: 'Watertown', state: 'NY', zipCode: '13601', county: 'Jefferson'},
  { name: 'Waterville Public Library', url: 'https://www.watervillelibrary.org', eventsUrl: 'https://www.watervillelibrary.org/events', city: 'Waterville', state: 'NY', zipCode: '13480', county: 'Oneida'},
