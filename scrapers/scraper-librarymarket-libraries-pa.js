...
const LIBRARIES = [
  {
    ...
    eventsUrl: 'https://events.yorklibraries.org/events/upcoming',
    city: 'York',
    state: 'PA',
    zipCode: '17401'
  },
  {
    ...
    eventsUrl: 'https://calendar.lancasterlibraries.org/events/upcoming',
    city: 'Lancaster',
    state: 'PA',
    zipCode: '17602'
  },
  {
    ...
    eventsUrl: 'https://bethlehemarea.librarycalendar.com/events/upcoming',
    city: 'Bethlehem',
    state: 'PA',
    zipCode: '18018'
  }
...
const SCRAPER_NAME = 'librarymarket-PA';
...
async function main() {
  ...
  await logScraperResult('Librarymarket Libraries PA', {
 ...
 */
async function scrapeLibraryMarketPACloudFunction() {
  console.log('☁️ Running librarymarket-PA as Cloud Function');
  const events = await scrapeGenericEvents();
  if (events.length > 0) {
    await saveToDatabase(events);
  }
...
module.exports = { scrapeGenericEvents, saveToDatabase, scrapeLibraryMarketPACloudFunction };
