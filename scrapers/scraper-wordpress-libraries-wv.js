...
const LIBRARIES = [
  ...
  { name: 'Pendleton County Public Library', url: 'https://www.franklinlibrary.org', eventsUrl: 'https://www.franklinlibrary.org/events', city: 'Franklin', state: 'WV', zipCode: '26807', county: 'Pendleton', urlCollision: 'franklinlibrary.org is dead or serves an unrelated site — no state entry is correct' },
  ...
  // URL corrected 2026-08-26 (was montgomerylibrary.org, a dead host shared with PA/NY/MA). montgomery.lib.wv.us 301s to fayette.lib.wv.us, which lists "507 Ferry Street, Montgomery, WV 25136-2229" among its five branches - the zipCode matches - and carries a real Programs and Event Calendar. Scraped at SYSTEM level because the branch has no separate site. county corrected to Fayette, the system that actually operates it.
  { name: 'Montgomery Public Library', url: 'https://fayette.lib.wv.us', eventsUrl: 'https://fayette.lib.wv.us/programs-and-events/', city: 'Montgomery', state: 'WV', zipCode: '25136', county: 'Fayette'},
  { name: 'Swaney Memorial Library', url: 'https://www.newcumberlandlibrary.org', eventsUrl: 'https://www.newcumberlandlibrary.org/events', city: 'New Cumberland', state: 'WV', zipCode: '26047', county: 'Hancock', urlCollision: 'newcumberlandlibrary.org is PA, not WV' },
  ...
  { name: 'Piedmont Public Library', url: 'https://www.piedmontlibrary.org', eventsUrl: 'https://www.piedmontlibrary.org/events', city: 'Piedmont', state: 'WV', zipCode: '26750', county: 'Mercer', urlCollision: 'piedmontlibrary.org is OK, not WV' },
